    ...
    return (
        <div className="bg-background text-on-background font-body antialiased selection:bg-primary selection:text-on-primary">
            ...
            <style dangerouslySetInnerHTML={{ __html: `
                @import url('https://fonts.googleapis.com/css2?family=Newsreader:ital,opsz,wght@0,6..72,200..800;1,6..72,200..800&family=Inter:wght@100..900&family=Raleway:wght@300&display=swap');
            ...
            <main>
                ...
                <section className="bg-white py-12 mx-auto" style={{ maxWidth: '95vw' }}>
                    <div className="mb-12 text-center flex flex-col items-center">
                        <span className="font-label uppercase tracking-[0.3em] text-[10px] text-zinc-400 block mb-4">BRANDING & POSICIONAMENTO</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
                        {[
                            ...
                            { title: 'Prestigio', subtitle: 'Branding', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDkA7crS5fwR9M1uHLxWGre8utOIQhLns1favg4_bqxW4l-Rhz-kocfZxJb59JIHoZo0AuTsli_xQD1X_z3OtXWtQY9FQl5HVclTTuNUMQKMWYswMESC7LVKN8Gt7F_wJV_yWoTwt54-Ob2IAfKZnaLu1muOYHzXGofG-8DJfHBXFuGu6w16J51hk_p07tLwwhj9yuhYxTb-0bc1SSn0oSkyr0OHqu7L7my2rY0YBwqS364_RTWjKGw1-ModtNWEmtX0VrKG9bErhw' },
                            { title: 'Espaço', subtitle: 'Curadoria', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDFIHY560gS2ik_2GrZpF30j-g-u298R2IvVTv99wXYupz5jW7ePfhi3hHeOSQJ2w4D9995OdagrtsKYEq0WGyCiUbF4XqHAZy8VekCTL3M9cJodpb-uNjUXVWrV7ILlVTT2zmqMUAfKFTDlPXy7VUL9uEwNMf_12u39Nub3mRFN41ZWd3eCg9gWp2qZXBlD5S3HKhbGnZX9ITFbVDfNSTbkEuWv7VCiQZHtzcmfE_8zY8HzN17A0gHtn7s99IzT0-_ft0gKKjVhO8' }
                        ].map((item, idx) => (
                            <div key={idx} className="relative group bg-white aspect-[4/3] overflow-hidden">
                                <img alt={item.title} className="w-full h-full object-cover grayscale transition-opacity duration-[0.6s] ease-in-out group-hover:opacity-0" src={item.img} />
                                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500 text-center p-4">
                                    <p className="font-headline text-sm text-black italic">{item.title}</p>
                                    <p className="font-label uppercase tracking-widest text-[7px] text-zinc-500 mt-1">{item.subtitle}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                        ...
                        <div className="flex-grow w-full py-4">
                            <div className="grid grid-cols-1 gap-y-8">
                                ...
                                <div className="max-w-xl text-left">
                                    ...
                                    <p className="font-['Raleway'] font-light uppercase tracking-[0.2em] text-[9px] text-zinc-500">Comunicação Intencional</p>
                                </div>
                                <div className="flex justify-end">
                                    <div className="max-w-xl text-right">
                                        ...
                                        <p className="font-headline text-lg italic text-zinc-400">É nesse ponto que entramos.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="max-w-[1400px] mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mx-auto max-w-[1386px]">
                            {[
                                ...
                                <div key={idx} className="space-y-8 flex flex-col items-center text-center mb-12">
                                    <div className="bg-zinc-100 overflow-hidden w-full aspect-square relative group cursor-pointer">
                                        <img className="w-full h-full object-cover grayscale" alt={person.name} src={person.img} />
                                    ...
                                    <div className="space-y-2">
                                        <p className="font-headline text-2xl font-medium">{person.name}</p>
                                        <p className="font-label uppercase tracking-widest text-[11px] font-light text-zinc-500">{person.role}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                ...
                <section className="bg-black px-12 relative overflow-hidden flex items-center justify-center min-h-[500px] py-[131px]">
                        ...
                        <div className="flex flex-col items-center">
                            <div className="relative w-full overflow-hidden mb-1">
                                {[
                                    ...
                                    { text: "Trabalhar com o Lucas e sua equipe foi o melhor investmento do ano. Eles entendem de negócio tanto quanto entendem de design.", author: "RICARDO M. — INVESTIDOR" }
                                ].map((slide, idx) => (
                                    <div key={idx} className={`testimonial-slide ${currentSlide === idx ? 'active' : ''}`}>
                                        ...
                                        <div className="pt-3">
                                            <p className="font-['Raleway'] uppercase tracking-[0.35em] text-[10px] text-white/80 font-light">{slide.author}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                            <div className="flex space-x-3 pt-4">
                                {[0, 1, 2].map((idx) => (
                                    <button 
                                        key={idx} 
                                        className={`indicator w-8 h-[1px] bg-white transition-opacity duration-300 ${currentSlide === idx ? '' : 'opacity-30'}`} 
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[48px] items-start">
                            ...
                            <div className="flex flex-col items-start text-left order-1">
                                <div className="mb-12">
                                    ...
                                    <a className="inline-block px-10 py-5 border border-black text-black font-label uppercase tracking-[0.2em] text-[8px] hover:bg-black hover:text-white transition-all duration-300" href="#">
                                        LER MAIS
                                    </a>
                                </div>
                                ...
                                <div className="flex flex-col items-start text-left mt-[120px]">
                                    ...
                                    <h2 className="font-headline text-black leading-tight mb-4 md:text-4xl">Não é sobre parecer melhor.</h2>
                                    <p className="text-secondary leading-loose max-w-md font-light mb-6 text-[12px]">
                                    ...
                                    <a className="inline-block px-10 py-5 border border-black text-black font-label uppercase tracking-[0.2em] text-[8px] hover:bg-black hover:text-white transition-all duration-300 mb-12" href="#">
                                        LER MAIS
                                    </a>
                                </div>
                            </div>
                ...
                <section className="bg-black py-64 px-12 text-center relative overflow-hidden" id="contato">
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto space-y-16">
                        ...
                        <div className="flex flex-col items-center space-y-8">
                            <a className="inline-block px-16 py-6 border-[0.5px] border-white text-white font-label uppercase tracking-[0.3em] text-[12px] hover:bg-white hover:text-black transition-all duration-300" href="#">
            ...
            <footer className="bg-neutral-950 text-neutral-50 py-24 px-8 border-t border-neutral-800">
                <div className="flex flex-col items-center text-center">
                    ...
                    <nav className="flex flex-wrap justify-center gap-x-12 gap-y-4 mb-16">
                        <a className="font-label text-[10px] text-neutral-500 hover:text-neutral-300 transition-colors" href="#">HOME</a>
                        ...
                        <a className="font-label text-[10px] text-neutral-50 text-neutral-300 transition-colors" href="#">ABOUT</a>
