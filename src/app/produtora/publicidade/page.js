        ...
        <div className="bg-surface text-on-surface font-body antialiased">
                ...
                <div className="relative w-full h-full bg-[#111111] flex items-center justify-end min-h-[calc(100vh-75px)] pb-[20px]">
                    <div className="relative z-20 w-full px-[60px] flex justify-end pr-[120px]">
                        <div className="w-full max-w-[600px] flex flex-col items-center text-center ml-[-10px]">
                            ...
                            <span className="font-label uppercase tracking-[0.4em] text-[10px] text-white/60 mb-6 block">CAMPANHA PUBLICITÁRIA</span>
                            <h1 className="font-headline text-4xl md:text-[3.6rem] text-white leading-[1.05] tracking-tight">Grandes campanhas não falham na ideia. Falham na execução.</h1>
                            <p className="font-label uppercase tracking-[0.2em] text-[12px] text-white/60 mt-4 mb-8 max-w-[450px] mx-auto leading-relaxed">Produção executiva para campanhas publicitárias com direção estratégica, gestão de equipe e controle total da operação.</p>
                            <div>
            ...
            <section className="bg-white py-0 px-[40px] pt-[25px]">
                <div className="bg-[#f5f5f5] pt-[4rem] md:pt-[5rem] pb-[10rem] md:pb-[12rem]">
                    <div className="max-w-[1440px] mx-auto px-6 text-center">
                        <span className="font-label uppercase tracking-[0.2em] text-[10px] text-black mb-4 block">PRODUÇÃO EXECUTIVA</span>
                        <h2 className="font-headline text-black mb-4 tracking-tight text-base md:text-[1.375rem] lg:text-[2.85rem] leading-tight">A Produção Executiva não entra para ajudar. Ela entra para governar.</h2>
                        <p className="text-on-surface-variant font-body font-light text-base md:text-lg max-w-2xl mx-auto mb-16">Direção. Operação. Execução. Tudo conectado.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-20">
                            <div className="flex flex-col items-center">
                                ...
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Direção & Criação</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Governança criativa do conceito à entrega final.</p>
                            </div>
                            <div className="flex flex-col items-center">
                                <span className="material-symbols-outlined text-4xl mb-6 text-on-surface/80" data-icon="movie_edit">movie_edit</span>
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Produção Audiovisual</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Captação, direção e entrega com padrão premium.</p>
                            </div>
                            <div className="flex flex-col items-center">
                                <span className="material-symbols-outlined text-4xl mb-6 text-on-surface/80" data-icon="style">style</span>
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Moda & Beleza</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Styling, hair e make alinhados ao conceito da campanha.</p>
                            </div>
                            <div className="flex flex-col items-center">
            ...
            <section className="bg-white px-[40px]">
                <div className="bg-black text-white py-32 px-12 md:px-24">
                    <div className="max-w-[1440px] mx-auto">
                        <h2 className="font-headline text-4xl md:text-5xl mb-24 tracking-tight">Produção comum vs Produção Executiva House.</h2>
            ...
            <section className="bg-white px-[40px]">
                <div className="bg-black py-32 px-12 md:px-24 text-center flex flex-col items-center">
                    <h2 className="font-headline text-3xl md:text-5xl text-white mb-12 max-w-3xl leading-snug">Se sua campanha precisa de estrutura real — seguimos.</h2>
