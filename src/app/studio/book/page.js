            ...
            <section className="bg-white px-[40px]">
                <div className="relative h-[769px] w-full flex items-center justify-center overflow-hidden bg-black">
                    ...
                    <div className="relative z-10 text-center px-8">
                        ...
                        <h2 className="font-headline text-3xl md:text-5xl text-white italic mb-6">"Hoje, quem não se comunica em vídeo, fica para trás."</h2>
                        <p className="font-label uppercase tracking-[0.3em] text-[10px] md:text-xs text-white/60">O mercado exige presença, fala e movemento.</p>
                    </div>
                </div>
            </section>
