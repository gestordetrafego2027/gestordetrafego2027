...
export default function BeatcoPage() {
    ...
    const images = Array.from({length: 16}, (_, i) => `/images/produtora/moda/beatco/${i+1}.jpg`);
    ...
    return (
        <div className="bg-surface text-on-surface antialiased">
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Beatco</h1>
                            </div>
            ...
            <PortfolioCTA businessUnit="produtora" projectSlug="beatco" />
