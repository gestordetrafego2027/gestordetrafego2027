...
export default function UniqueChicPage() {
    ...
    const images = Array.from({length: 5}, (_, i) => `/images/produtora/moda/unique-chic/${i+1}.jpg`);
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface">Unique Chic</h1>
                            </div>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-8 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-xs text-on-surface-variant leading-relaxed">Direção de imagem com foco em identity visual e posicionamento pessoal.</p>
                            </div>
                        </div>
                    </div>
                </div>
