...
export default function ElyahPage() {
    ...
    const images = Array.from({length: 9}, (_, i) => `/images/produtora/acessorios/elyah/${i+1}.jpg`);
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Elyah</h1>
                            </div>
