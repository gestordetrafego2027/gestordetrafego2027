...
export default function SamratPage() {
    useEffect(() => {
        ...
        function animate() {
            ...
            if (infoCol) infoCol.style.transform = 	ranslateY(px);
                    ...
                    <div className="lg:w-2/3 flex flex-col gap-8">
                        {verticalImages.map((src, i) => (
                            <div key={i} className="image-anim relative overflow-hidden group">
                                <img alt="Samrat vertical" className="w-full grayscale hover:grayscale-0 transition-all duration-700" src={src}/>
                            </div>
                        ))}
                        {horizontalImages.map((src, i) => (
                            <div key={i} className="image-anim relative overflow-hidden group">
                                <img alt="Samrat horizontal" className="w-full grayscale hover:grayscale-0 transition-all duration-700" src={src} style={{aspectRatio:'16/9', objectFit:'cover'}}/>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface">Samrat</h1>
                            </div>
