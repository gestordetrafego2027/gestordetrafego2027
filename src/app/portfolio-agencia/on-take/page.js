                    ...
                    <div className="lg:w-2/3 flex flex-col gap-8">
                        {verticalImages.map((src, i) => (
                            <div key={i} className="image-anim relative overflow-hidden group">
                                <img alt="On Take vertical" className="w-full grayscale hover:grayscale-0 transition-all duration-700" src={src}/>
                            </div>
                        ))}
                        {horizontalImages.map((src, i) => (
                            <div key={i} className="image-anim relative overflow-hidden group">
                                <img alt="On Take horizontal" className="w-full grayscale hover:grayscale-0 transition-all duration-700" src={src} style={{aspectRatio:'16/9', objectFit:'cover'}}/>
                            </div>
                        ))}
                    </div>
