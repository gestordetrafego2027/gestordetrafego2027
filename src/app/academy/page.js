...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/images/academy/hero-academy.webp',
        width: 1416,
        height: 817,
        alt: 'House Mazzutti Academy — bastidores de workshop',
      },
    ],
  },
  twitter: {
...
const BOOKS = [
  ...
  },
  {
    ...
    vol: 'Vol. 03',
    year: '2026',
    title: 'Briefing Mal Passado',
    subtitle: 'Bastidores do caos criativo na publicidade brasileira. 25 capítulos sobre o monstro silencioso que atravessa o ofício inteiro — por Ângelo Mazzutti.',
    pages: '417',
    chapters: '25',
    format: 'PDF + Impresso',
    priceFull: null,
    slug: 'briefing-mal-passado',
    price: priceLabelForSlug('briefing-mal-passado'),
    discount: null,
    href: '/pt/academy/briefing-mal-passado',
