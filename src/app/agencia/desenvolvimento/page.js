...
export default function AgenciaDesenvolvimentoPage() {
    ...
    return (
        <div className="bg-surface text-on-surface font-body antialiased">
            <title>House Mazzutti — AGÊNCIA | Web Development</title>
            <meta name="description" content="Criação de sites profissionais, e-commerce e plataformas digitais com design premium, SEO e alta conversão." />
            ...
            <h1 className="sr-only">Desenvolvimento de Sites Premium e Web Development</h1>
                ...
                <div className="relative w-full h-full bg-[#111111] flex items-center justify-end min-h-[calc(100vh-75px)] pb-[20px]">
                    <div className="relative z-20 w-full px-[60px] flex justify-end pr-[120px]">
                        <div className="w-full max-w-[600px] flex flex-col items-center text-center ml-[-10px]">
                            ...
                            <span className="font-label uppercase tracking-[0.4em] text-[10px] text-white/60 mb-6 block" data-aos="fade-up" data-aos-delay="100">WEB DEVELOPMENT</span>
                            <h1 className="font-headline text-4xl md:text-[3.6rem] text-white leading-[1.05] tracking-tight hmzt-hero-title" data-aos="fade-up" data-aos-delay="200">Seu site não é um projeto. É o ativo mais importante da sua marca online.</h1>
            ...
            <section className="bg-white py-0 px-[40px] pt-[25px]">
                <div className="bg-[#f5f5f5] pt-[4rem] md:pt-[5rem] pb-[10rem] md:pb-[12rem]">
                    <div className="max-w-[1440px] mx-auto px-6 text-center">
                        ...
                        <h2 className="font-headline text-black mb-4 tracking-tight text-base md:text-[1.375rem] lg:text-[2.85rem] leading-tight" data-aos="fade-up" data-aos-delay="100">Não desenvolvemos sites. Construímos presença digital com valor.</h2>
                        <p className="text-on-surface-variant font-body font-light text-base md:text-lg max-w-2xl mx-auto mb-16" data-aos="fade-up" data-aos-delay="200">Seu site é o único lugar onde tudo é seu. Sem algoritmo. Sem distração.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-20">
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Estratégia Digital</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Diagnóstico, arquitetura e narrativa antes do desenvolvimento.</p>
                            </div>
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
                                <span className="material-symbols-outlined text-4xl mb-6 text-on-surface/80" data-icon="palette">palette</span>
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Direção de Arte</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Layout autoral e responsivo alinhado ao posicionamento.</p>
                            </div>
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="300">
                                <span className="material-symbols-outlined text-4xl mb-6 text-on-surface/80" data-icon="code">code</span>
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Desenvolvimento Técnico</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Construção profissional com performance e segurança.</p>
                            </div>
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="400">
                                <span className="material-symbols-outlined text-4xl mb-6 text-on-surface/80" data-icon="search">search</span>
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">SEO Estruturado</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Arquitetura de busca para crescimento orgânico real.</p>
                            </div>
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="500">
                                <span className="material-symbols-outlined text-4xl mb-6 text-on-surface/80" data-icon="integration_instructions">integration_instructions</span>
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Integrações</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">WhatsApp, CRM, analytics e automações.</p>
                            </div>
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Suporte & Evolução</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Manutenção, atualização e crescimento contínuo.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="relative aspect-square group overflow-hidden bg-black">
                            ...
                            <div className="absolute inset-0 bg-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center">
                                <div className="bg-black/60 w-[86%] aspect-square flex flex-col items-center justify-center">
                                    ...
                                    <span className="text-white font-headline text-lg italic">Web Development</span>
                                </div>
                            </div>
                        </div>
                        <div className="relative aspect-square group overflow-hidden bg-black">
            ...
            <section className="bg-white px-[40px]">
                <div className="relative h-[769px] w-full flex items-center justify-center overflow-hidden bg-black">
                    ...
                    <div className="relative z-10 text-center px-8">
                        ...
                        <h2 className="font-headline text-3xl md:text-5xl text-white italic mb-6">"Seu site é a forma como o mercado entende quem você é."</h2>
                        <p className="font-label uppercase tracking-[0.3em] text-[10px] md:text-xs text-white/60">O único lugar onde tudo é seu. Sem algoritmo. Sem concorrência ao lado.</p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-4 mb-12">
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Site institucional
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Design responsivo
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> SEO básico
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div className="p-12 border border-zinc-100 flex flex-col justify-between h-full bg-white transition-all duration-300 hover:bg-black hover:text-white hover:scale-[1.02] group relative overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-4 mb-12">
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Site completo / E-commerce
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Integrações
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> SEO estruturado
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div className="p-12 border border-zinc-100 flex flex-col justify-between h-full bg-white transition-all duration-300 hover:bg-black hover:text-white hover:scale-[1.02] group" data-aos="fade-up" data-aos-delay="300">
                                <div>
                                    <h3 className="font-headline text-2xl mb-8">PLATAFORMA</h3>
                                    <div className="mb-12">
                                        <span className="text-4xl font-headline italic">Sob consulta</span>
                                    </div>
                                    <ul className="space-y-4 mb-12">
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Desenvolvimento completo
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Performance
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Suporte contínuo
                                        </li>
                                    </ul>
                                </div>
            ...
            <section className="bg-white px-[40px]">
                <div className="bg-black text-white py-32 px-12 md:px-24">
                    <div className="max-w-[1440px] mx-auto">
                        <h2 className="font-headline text-4xl md:text-5xl mb-24 tracking-tight" data-aos="fade-up">Presença Estratégica.</h2>
                            ...
                            <div data-aos="fade-right">
                                ...
                                <ul className="space-y-10">
                                    <li className="flex items-start gap-6">
                                        ...
                                        <div>
                                            <p className="font-headline text-lg mb-2">Presença com Valor</p>
                                            <p className="text-white/50 text-sm">Marca que comunica, posiciona e converte.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="check_circle">check_circle</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Ativo Estratégico</p>
                                            <p className="text-white/50 text-sm">Site que trabalha pela sua marca 24 horas por dia.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="check_circle">check_circle</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Crescimento Estruturado</p>
                                            <p className="text-white/50 text-sm">Base técnica preparada para escalar.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div data-aos="fade-left">
                                ...
                                <ul className="space-y-10">
                                    <li className="flex items-start gap-6 opacity-40">
                                        ...
                                        <div>
                                            <p className="font-headline text-lg mb-2">Imagem Amadora</p>
                                            <p className="text-white/50 text-sm">Site que prejudica credibilidade e afasta oportunidades.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6 opacity-40">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="cancel">cancel</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Oportunidades Perdidas</p>
                                            <p className="text-white/50 text-sm">Presença digital fraca que limita crescimento.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6 opacity-40">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="cancel">cancel</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Dependência de Plataformas</p>
                                            <p className="text-white/50 text-sm">Sem controle sobre sua própria comunicação.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
            ...
            <section className="bg-white px-[40px]">
                <div className="bg-black py-32 px-12 md:px-24 text-center flex flex-col items-center">
                    <h2 className="font-headline text-3xl md:text-5xl text-white mb-12 max-w-3xl leading-snug hmzt-hero-title" data-aos="fade-up" data-aos-delay="100">Sua presença digital começa aqui.</h2>
