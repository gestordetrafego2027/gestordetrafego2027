...
export default function AgenciaBrandingPage() {
    ...
    return (
        <div className="bg-surface text-on-surface font-body antialiased">
            <title>House Mazzutti — AGÊNCIA | Branding Project</title>
            <meta name="description" content="Desenvolvimento completo de marca com branding estratégico, identidade visual profissional e aplicação real para empresas que buscam posicionamento e valor percebido." />
            ...
            <h1 className="sr-only">Branding Estratégico e Identidade Visual para Construção de Marca</h1>
                ...
                <div className="relative w-full h-full bg-[#111111] flex items-center justify-end min-h-[calc(100vh-75px)] pb-[20px]">
                    <div className="relative z-20 w-full px-[60px] flex justify-end pr-[120px]">
                        <div className="w-full max-w-[600px] flex flex-col items-center text-center ml-[-10px]">
                            ...
                            <span className="font-label uppercase tracking-[0.4em] text-[10px] text-white/60 mb-6 block" data-aos="fade-up" data-aos-delay="100">BRANDING PROJECT</span>
                            <h1 className="font-headline text-4xl md:text-[3.6rem] text-white leading-[1.05] tracking-tight hmzt-hero-title" data-aos="fade-up" data-aos-delay="200">Marca não começa no visual. Começa na forma como ela é definida.</h1>
                            <p className="font-label uppercase tracking-[0.2em] text-[12px] text-white/60 mt-4 mb-8 max-w-[450px] mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="300">Branding estratégico, identidade visual e construção completa de marca com estrutura e aplicação real.</p>
            ...
            <section className="bg-white py-0 px-[40px] pt-[25px]">
                <div className="bg-[#f5f5f5] pt-[4rem] md:pt-[5rem] pb-[10rem] md:pb-[12rem]">
                    <div className="max-w-[1440px] mx-auto px-6 text-center">
                        ...
                        <h2 className="font-headline text-black mb-4 tracking-tight text-base md:text-[1.375rem] lg:text-[2.85rem] leading-tight max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="100">Não criamos apenas identidade visual. Criamos uma base que sustenta percepção, valor e posicionamento.</h2>
                        <p className="text-on-surface-variant font-body font-light text-base md:text-lg max-w-2xl mx-auto mb-16" data-aos="fade-up" data-aos-delay="200">Quando a marca é bem definida, ela não precisa se explicar. Ela é compreendida.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-20">
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Estratégia de Marca</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Posicionamento, narrativa e direção antes de qualquer criação.</p>
                            </div>
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Identidade Visual</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Sistema completo com logotipo, cores e tipografia.</p>
                            </div>
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="300">
                                <span className="material-symbols-outlined text-4xl mb-6 text-on-surface/80" data-icon="menu_book">menu_book</span>
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Brand Book</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Documentação completa da marca com diretrizes de uso.</p>
                            </div>
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="400">
                                <span className="material-symbols-outlined text-4xl mb-6 text-on-surface/80" data-icon="palette">palette</span>
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Sistema Gráfico</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Linguagem visual consistente para todos os canais.</p>
                            </div>
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="500">
                                <span className="material-symbols-outlined text-4xl mb-6 text-on-surface/80" data-icon="devices">devices</span>
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Aplicações</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Materiais impressos, digitais e mockups prontos para uso.</p>
                            </div>
                            <div className="flex flex-col items-center" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <h3 className="font-headline mb-4 tracking-tight !text-lg">Consistência Total</h3>
                                <p className="text-on-surface-variant leading-relaxed font-light max-w-xs !text-[13px]">Marca clara e aplicável em qualquer ponto de contato.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="relative aspect-square group overflow-hidden bg-black">
                            ...
                            <div className="absolute inset-0 bg-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center">
                                <div className="bg-black/60 w-[86%] aspect-square flex flex-col items-center justify-center">
                                    <span className="text-white font-label text-[10px] tracking-[0.3em] mb-1">AGÊNCIA</span>
                                    <span className="text-white font-headline text-lg italic">Branding</span>
                                </div>
                            </div>
                        </div>
                        <div className="relative aspect-square group overflow-hidden bg-black">
            ...
            <section className="bg-white px-[40px]">
                <div className="relative h-[769px] w-full flex items-center justify-center overflow-hidden bg-black">
                    ...
                    <div className="relative z-10 text-center px-8">
                        ...
                        <h2 className="font-headline text-3xl md:text-5xl text-white italic mb-6">"Quando a marca é bem definida, ela não precisa se explicar. Ela é compreendida."</h2>
                        <p className="font-label uppercase tracking-[0.3em] text-[10px] md:text-xs text-white/60">Estratégia. Linguagem. Identidade. Aplicação. Tudo organizado.</p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-4 mb-12">
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Branding Book
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Posicionamento
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Narrativa de marca
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div className="p-12 border border-zinc-100 flex flex-col justify-between h-full bg-white transition-all duration-300 hover:bg-black hover:text-white hover:scale-[1.02] group relative overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-4 mb-12">
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Branding completo
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Identidade visual
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Manual de marca
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div className="p-12 border border-surface-container-high flex flex-col justify-between h-full bg-white transition-all duration-300 hover:bg-black hover:text-white hover:scale-[1.02] group" data-aos="fade-up" data-aos-delay="300">
                                <div>
                                    ...
                                    <ul className="space-y-4 mb-12">
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Sistema completo
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Aplicações
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Suporte de implementação
                                        </li>
                                    </ul>
                                </div>
            ...
            <section className="bg-white px-[40px]">
                <div className="bg-black text-white py-32 px-12 md:px-24">
                    <div className="max-w-[1440px] mx-auto">
                        <h2 className="font-headline text-4xl md:text-5xl mb-24 tracking-tight" data-aos="fade-up">Identidade vs Marca.</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
                            <div data-aos="fade-right">
                                <h3 className="font-label uppercase tracking-[0.2em] text-[10px] text-white/40 mb-12">COM BRANDING</h3>
                                <ul className="space-y-10">
                                    <li className="flex items-start gap-6">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="check_circle">check_circle</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Marca que Funciona</p>
                                            <p className="text-white/50 text-sm">Clara, consistente e preparada para crescer com método.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="check_circle">check_circle</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Percepção de Valor</p>
                                            <p className="text-white/50 text-sm">Posicionamento que sustenta preço e autoridade.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="check_circle">check_circle</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Estrutura Real</p>
                                            <p className="text-white/50 text-sm">Base que organiza comunicação em todos os canais.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="font-label uppercase tracking-[0.2em] text-[10px] text-white/40 mb-12">SEM BRANDING</h3>
                                <ul className="space-y-10">
                                    <li className="flex items-start gap-6 opacity-40">
                                        ...
                                        <div>
                                            <p className="font-headline text-lg mb-2">Marca Fragmentada</p>
                                            <p className="text-white/50 text-sm">Identidade inconsistente que prejudica credibilidade.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6 opacity-40">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="cancel">cancel</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Dependência de Esforço</p>
                                            <p className="text-white/50 text-sm">Comunicação que precisa se explicar constantemente.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6 opacity-40">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="cancel">cancel</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Crescimento Limitado</p>
                                            <p className="text-white/50 text-sm">Marca que não sustenta expansão ou escalonamento.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
            ...
            <section className="bg-white px-[40px]">
                <div className="bg-black py-32 px-12 md:px-24 text-center flex flex-col items-center">
                    <h2 className="font-headline text-3xl md:text-5xl text-white mb-12 max-w-3xl leading-snug hmzt-hero-title" data-aos="fade-up" data-aos-delay="100">Sua marca começa aqui.</h2>
            ...
            <FormDrawer
                isOpen={!!formCta}
                onClose={closeForm}
                title="Iniciar projeto de branding"
                subtitle="Conte-nos sobre sua marca. Respondemos em até 1 dia útil."
            >
                <FormAgenciaB2B
                    onClose={closeForm}
                    sourceUrl="/agencia/branding"
