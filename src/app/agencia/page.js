                        ...
                        return <>
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-center px-12 md:pl-48">
                                <div className="max-w-3xl">
                                    <span className="hero-animate font-label uppercase tracking-[0.3em] text-[10px] text-white/60 mb-6 block" style={{ opacity: 0, transform: 'translateY(30px)' }}>AGÊNCIA</span>
