        ...
        <div className="bg-surface text-on-surface font-body antialiased">
                ...
                <div className="relative w-full h-full bg-[#111111] flex items-center justify-end min-h-[calc(100vh-75px)] pb-[20px]">
                    <div className="relative z-20 w-full px-[60px] flex justify-end pr-[120px]">
                        <div className="w-full max-w-[600px] flex flex-col items-center text-center ml-[-10px]">
                            ...
                            <span className="font-label uppercase tracking-[0.4em] text-[10px] text-white/60 mb-6 block" data-aos="fade-up" data-aos-delay="100">CAMPANHAS</span>
                            <h1 className="font-headline text-4xl md:text-[3.6rem] text-white leading-[1.05] tracking-tight hmzt-hero-title" data-aos="fade-up" data-aos-delay="200">Campanhas não começam no conteúdo. Começam na forma como o impacto é construído.</h1>
            ...
            <section className="bg-white px-[40px]">
                <div className="bg-black text-white py-32 px-12 md:px-24">
                    <div className="max-w-[1440px] mx-auto">
                        <h2 className="font-headline text-4xl md:text-5xl mb-24 tracking-tight" data-aos="fade-up">Sistemas de Impacto.</h2>
            ...
            <section className="bg-white px-[40px]">
                <div className="bg-black py-32 px-12 md:px-24 text-center flex flex-col items-center">
                    <h2 className="font-headline text-3xl md:text-5xl text-white mb-12 max-w-3xl leading-snug hmzt-hero-title" data-aos="fade-up" data-aos-delay="100">Sua campanha começa aqui.</h2>
            ...
            <FormDrawer
                isOpen={!!formCta}
                onClose={closeForm}
                title="Estruturar campanha"
                subtitle="Conte-nos sobre sua campanha. Respondemos em até 1 dia útil."
            >
                <FormAgenciaB2B
                    onClose={closeForm}
                    sourceUrl="/agencia/campanhas"
                    serviceOfInterest="campanhas"
