...
export default function BeatcoPage() {
    ...
    const images = Array.from({length: 8}, (_, i) => `/images/produtora/moda/beatco/${i+1}.webp`);
    ...
    return (
        <div className="bg-surface text-on-surface antialiased">
                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">"Performance vira editorial quando há direção."</p>
            ...
            <PortfolioVideo unit="produtora" slug="beatco" />

            <YouTubeShort urls="https://youtube.com/shorts/u41gN8xO_2M?feature=share" />
