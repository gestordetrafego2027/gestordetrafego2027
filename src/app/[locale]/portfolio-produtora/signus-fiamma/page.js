...
export default function SignusFiammaPage() {
    ...
    const images = Array.from({length: 5}, (_, i) => `/images/produtora/acessorios/signus-fiamma/${i+1}.webp`);
                        ...
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <div className="space-y-[16px] pt-4">
                                ...
                                <p className="font-inter text-[10px] italic text-outline-variant leading-relaxed mt-4">
                                    {`Produção Executiva: Mateus Sacavem · Fotografia: Neto Lins · Vídeo: Thyago Barriviera · Beauty: Rodrigo Frois · Modelo: Gabriel · Stylist: Deise Smaniotto`}
                                </p>
                            </div>
                            </div>
