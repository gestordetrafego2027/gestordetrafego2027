...
export default function SignusVertzPage() {
    ...
    const images = Array.from({length: 5}, (_, i) => `/images/produtora/acessorios/signus-vertz/${i+1}.webp`);
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Signus - Vertz</h1>
                            </div>
                            <div className="h-px w-12 bg-outline-variant/30"></div>
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">"Cada marca dentro do grupo precisa do seu próprio eixo."</p>
                            <div className="space-y-[16px] pt-4">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Campanha em leitura editorial mais jovem e direta — eixo visual na força da modelo em planos fechados, fashion film, beauty e set em uma só linha narrativa. Personalidade distinta dentro do portfólio do grupo.`}
                                </p>
                                <p className="font-inter text-[10px] italic text-outline-variant leading-relaxed mt-4">
                                    {`Produção Executiva: Mateus Sacavem · Fotografia: Neto Lins · Vídeo: Thyago Barriviera · Beauty: Rodrigo Frois · Modelo: Ivia · Stylist: Deise Smaniotto`}
                                </p>
                            </div>
                            </div>
