...
export default function ProjetoProdutoraPage() {
    useEffect(() => {
    ...
    return (
        <div className="bg-surface text-on-surface antialiased">
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface">Projeto Produtora</h1>
                            </div>
                            ...
                            <div className="space-y-[16px] pt-4">
                                <div className="info-col-anim flex flex-col">
                                    ...
                                    <p className="font-inter text-sm font-medium">Produtora</p>
                                </div>
                                <div className="info-col-anim flex flex-col">
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-8 border border-outline-variant/10">
                                <h3 className="font-newsreader text-xl mb-4">Filosofia da Produtora</h3>
                                <p className="font-inter text-xs text-on-surface-variant leading-relaxed">
                                    Produzir não é o problema. Produzir sem critério é. A Produtora não começa no fazer — começa no que já foi definido. Posicionamento. Narrativa. Direção. A partir disso, tudo ganha forma.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <PortfolioCTA businessUnit="produtora" />
