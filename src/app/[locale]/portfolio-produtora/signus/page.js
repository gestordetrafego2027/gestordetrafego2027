...
export default function SignusPage() {
    ...
    const images = Array.from({length: 5}, (_, i) => `/images/produtora/acessorios/signus/${i+1}.webp`);
    ...
    return (
        <div className="bg-surface text-on-surface antialiased">
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Signus</h1>
                            </div>
                            <div className="h-px w-12 bg-outline-variant/30"></div>
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">"Óculos como assinatura — não como item."</p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-[10px] italic text-outline-variant leading-relaxed mt-4">
                                    {`Produção Executiva: Mateus Sacavem · Fotografia: Neto Lins · Vídeo: Thyago Barriviera · Beauty: Rodrigo Frois · Modelo: Isnia Machado · Stylist: Deise Smaniotto`}
                                </p>
                            </div>
                            </div>
            ...
            <PortfolioVideo unit="produtora" slug="signus" />
