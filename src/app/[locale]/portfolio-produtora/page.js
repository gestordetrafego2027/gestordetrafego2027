        ...
        <div className="bg-white text-on-surface selection:bg-black selection:text-white min-h-screen">
                ...
                <section className="bg-white w-full py-[16px] px-[40px]">
                    <div className="grid grid-cols-1 md:grid-cols-3 w-full gap-[20px]">
                        <Link href="/portfolio-produtora/barbara-porto" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/barbara-porto/capa.webp" alt="Barbara Porto" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                        ...
                        <Link href="/portfolio-produtora/camila-scarpa" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/camila-scarpa/capa.webp" alt="Camila Scarpa" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/poema-paris" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/poema-paris/capa.webp" alt="Poema Paris" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/pontok" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/pontok/capa.webp" alt="PontoK" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/dumond" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/dumond/capa.webp" alt="Dumond" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/signus" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/signus/capa.webp" alt="Signus" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/signus-versolato01" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/signus-versolato01/capa.webp" alt="Signus Versolato 01" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/signus-versolato02" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/signus-versolato02/capa.webp" alt="Signus Versolato 02" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/signus-vertz" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/signus-vertz/capa.webp" alt="Signus Vertz" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/elyah" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/elyah/capa.webp" alt="Elyah" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/signus-fiamma" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/signus-fiamma/capa.webp" alt="Signus Fiamma" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/signus-lavorato" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/signus-lavorato/capa.webp" alt="Signus Lavorato" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/monica-costa-jewerly" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/monica-costa-jewerly/capa.webp" alt="Monica Costa Jewerly" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/signus-jean-pierre" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/acessorios/signus-jean-pierre/capa.webp" alt="Signus Jean Pierre" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">ACESSÓRIOS</span>
                        ...
                        <Link href="/portfolio-produtora/alletto-still" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/beleza/alletto-still/capa.webp" alt="Alletto Still" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                        ...
                        <Link href="/portfolio-produtora/jequiti-sense" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/beleza/jequiti-sense/capa.webp" alt="Jequiti - Sense" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">BELEZA</span>
                        ...
                        <Link href="/portfolio-produtora/we-pink-01" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/beleza/we-pink-01/capa.webp" alt="We Pink 01" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">BELEZA</span>
                        ...
                        <Link href="/portfolio-produtora/natalia-beauty" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/beleza/natalia-beauty/capa.webp" alt="Natalia Beauty" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">BELEZA</span>
                        ...
                        <Link href="/portfolio-produtora/oceane" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/beleza/oceane/capa.webp" alt="Oceane" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">BELEZA</span>
                        ...
                        <Link href="/portfolio-produtora/beatco" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/moda/beatco/capa.webp" alt="Beatco" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                        ...
                        <Link href="/portfolio-produtora/pous" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/moda/pous/capa.webp" alt="Pous" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">MODA</span>
                        ...
                        <Link href="/portfolio-produtora/toli" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/moda/toli/capa.webp" alt="Toli" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">MODA</span>
                        ...
                        <Link href="/portfolio-produtora/unique-chic" className="gallery-item relative overflow-hidden bg-[#f3f3f4] w-full block" style={{aspectRatio: '2/3'}}>
                            <Image src="/images/produtora/moda/unique-chic/capa.webp" alt="Unique Chic" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="w-full h-full object-cover object-center" />
                            <div className="overlay absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                                <span className="font-raleway text-[12px] uppercase tracking-[0.2em] text-black mb-2">MODA</span>
            ...
            <footer className="bg-white border-t border-zinc-200 w-full flex justify-between items-center px-[48px] py-[32px] text-zinc-900">
                ...
                <div className="flex gap-8 items-center">
                    <Link className="font-manrope text-[10px] uppercase tracking-wider text-[#333] hover:text-white transition-colors duration-300" href="https://instagram.com/housemazzutti" target="_blank" rel="noopener noreferrer">INSTAGRAM</Link>
                    <Link className="font-manrope text-[10px] uppercase tracking-wider text-[#333] hover:text-white transition-colors duration-300" href="https://www.linkedin.com/company/house-mazzutti" target="_blank" rel="noopener noreferrer">LINKEDIN</Link>
                </div>
