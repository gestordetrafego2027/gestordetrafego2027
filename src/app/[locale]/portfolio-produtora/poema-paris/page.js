...
export default function PoemasParisPage() {
    ...
    const images = Array.from({length: 10}, (_, i) => `/images/produtora/acessorios/poema-paris/${i+1}.webp`);
                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">"Sapato é objeto sensorial — campanha precisa traduzir isso."</p>
