...
export default function WePinkZeFelipePage() {
    ...
    const images = Array.from({length: 4}, (_, i) => `/images/produtora/beleza/we-pink-ze-felipe/${i+1}.webp`);
    ...
    return (
        <div className="bg-surface text-on-surface antialiased">
                        ...
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-[10px] italic text-outline-variant leading-relaxed mt-4">
                                    {`Produção Executiva: Angelo Mazzutti · Fotografia: Ita Mazzutti · Vídeo: Lucas Brando · Beauty: Nikolas Beauty · Artistas: Virginia Fonseca, Zé Felipe`}
                                </p>
                            </div>
                            </div>
            ...
            <YouTubeShort urls="https://youtube.com/shorts/AmfGK-XrA2I?feature=share" />
