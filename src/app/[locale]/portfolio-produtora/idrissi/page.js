                        ...
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <div className="space-y-[16px] pt-4">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Lookbook e campanha de moda da Idrissi, com direção de imagem e produção executiva da House Mazzutti — do conceito ao set.`}
                                </p>
                                <p className="font-inter text-[10px] italic text-outline-variant leading-relaxed mt-4">
                                    {`Produção Executiva: Mateus Sacavem · Fotografia: Ita Mazzutti · Vídeo: Lucas Brando · Beauty: Andre Mattos · Modelo: Fernanda Diolive`}
                                </p>
                            </div>
                            </div>
