...
export default function IdrissiPage() {
    ...
    const images = Array.from({length: 7}, (_, i) => `/images/produtora/moda/idrissi/${i+1}.webp`);
        ...
        <div className="bg-surface text-on-surface antialiased">
                ...
                <div className="flex flex-col lg:flex-row gap-16">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          {images.map((src, i) => (
                            <div key={i} onClick={() => openImg(i)} className="cursor-pointer">
                              <Image alt={`Idrissi — Foto ${i+1}`} style={{objectPosition: 'top'}} src={src} width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                            </div>
                          ))}
                        </div>
                    </div>
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">"O vestido conta a história — a direção a coloca em escala."</p>
                            <div className="space-y-[16px] pt-4">
                                ...
                                <div className="info-col-anim flex flex-col"><p className="font-inter text-[9px] uppercase tracking-[0.2em] text-outline-variant mb-1">Marca</p><p className="font-inter text-sm font-medium">Idrissi</p></div>
                                <div className="info-col-anim flex flex-col"><p className="font-inter text-[9px] uppercase tracking-[0.2em] text-outline-variant mb-1">Modelo</p><p className="font-inter text-sm font-medium">Fernanda Dio Live</p></div>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Sessão editorial densa como instalação de assinatura visual — combinação entre coleção, modelo e ambiente. Elenco, beauty, fashion film e estilo em uma só linha narrativa. Coleção apresentada como universo de marca, não como inventário comercial.`}
                                </p>
            ...
            <div className="px-8 pb-12 max-w-[1600px] mx-auto">
                <div className="flex justify-between items-center border-t border-outline-variant/15 pt-12">
                    <Link className="group flex items-center space-x-4 text-on-surface-variant hover:text-black transition-colors" href="/portfolio-produtora/beatco-2"><span className="material-symbols-outlined text-sm">west</span><span className="font-inter text-[9px] uppercase tracking-[0.2em]">Beat Co 2</span></Link>
