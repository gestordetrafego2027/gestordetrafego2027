                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Pous</h1>
                            </div>
                            <div className="h-px w-12 bg-outline-variant/30"></div>
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">"Lookbook não é catálogo — é mundo de marca."</p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Lookbook editorial em diálogo entre coleção, modelo e ambiente. Elenco e set em uma só linha — apresentação adulta e contemporânea. Coleção apresentada com densidade que diferencia marca de produto, não apenas como entrega comercial.`}
                                </p>
                                <p className="font-inter text-[10px] italic text-outline-variant leading-relaxed mt-4">
                                    {`Produção Executiva: Mateus Sacavem · Fotografia: Thyago Barriviera · Vídeo: Rebeca Cabral · Modelo: Deise Smaniotto`}
                                </p>
                            </div>
                            </div>
