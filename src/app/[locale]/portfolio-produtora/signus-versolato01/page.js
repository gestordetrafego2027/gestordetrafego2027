...
export default function SignusVersolato01Page() {
    ...
    const images = Array.from({length: 5}, (_, i) => `/images/produtora/acessorios/signus-versolato01/${i+1}.webp`);
    ...
    return (
        <div className="bg-surface text-on-surface antialiased">
                        ...
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-[10px] italic text-outline-variant leading-relaxed mt-4">
                                    {`Produção Executiva: Mateus Sacavem · Fotografia: Thyago Barriviera · Vídeo: Caio Marcandali · Beauty: Andre Mattos · Modelo: Gianne Albertoni · Stylist: Deise Smaniotto`}
                                </p>
                            </div>
                            </div>
            ...
            <PortfolioVideo unit="produtora" slug="signus-versolato01" />

            <YouTubeShort urls="https://youtube.com/shorts/FtD8DSVlYYg?feature=share" />
