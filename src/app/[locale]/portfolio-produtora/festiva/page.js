        ...
        <div className="bg-surface text-on-surface antialiased">
            ...
            {selectedImg && (
              <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center" onClick={closeImg}>
                <Image src={selectedImg} alt={`Festiva — House Mazzutti, imagem ampliada`} fill sizes="100vw" quality={80} loading="lazy" className="max-h-screen max-w-screen object-contain" />
              </div>
            )}
        </div>
    );
