...
export default function SignusLavoratoPage() {
    ...
    const images = Array.from({length: 5}, (_, i) => `/images/produtora/acessorios/signus-lavorato/${i+1}.webp`);
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Signus - Lavorato</h1>
                            </div>
                            <div className="h-px w-12 bg-outline-variant/30"></div>
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">"Diálogo entre geometria e estrutura facial é o que sustenta."</p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Campanha em narrativa editorial adulta — cada quadro a partir do diálogo entre geometria da armação e estrutura facial. Elenco, beauty, fashion film e estilo em uma só linha. Banco denso para mídia editorial, ponto de venda e canal de óticas.`}
                                </p>
                                <p className="font-inter text-[10px] italic text-outline-variant leading-relaxed mt-4">
                                    {`Direção Criativa: Angelo Mazzutti · Produção Executiva: Mateus Sacavem · Fotografia: Neto Lins · Vídeo: Thyago Barriviera · Beauty: Rodrigo Frois · Modelo: Erica Redling · Stylist: Deise Smaniotto`}
                                </p>
                            </div>
                        </div>
                    </div>
