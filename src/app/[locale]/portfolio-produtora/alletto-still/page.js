...
export default function AllettoStillPage() {
    ...
    const images = [
        '/images/produtora/beleza/alletto-still/1.webp',
        '/images/produtora/beleza/alletto-still/2.webp',
        '/images/produtora/beleza/alletto-still/3.webp',
        '/images/produtora/beleza/alletto-still/4.webp',
        '/images/produtora/beleza/alletto-still/5.webp',
    ];
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Skincare se vende pela textura — e a textura precisa de luz."
                            </p>
                            <div className="space-y-[16px] pt-4">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Campanha em narrativa visual mínima — sem ruído, sem excesso — para que cada quadro entregue o que importa na categoria: textura, luz, autoridade. Banco editorial para lançamento, mídia, ponto de venda e canal próprio sob a mesma assinatura.`}
                                </p>
