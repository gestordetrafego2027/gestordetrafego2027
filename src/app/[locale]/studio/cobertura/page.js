...
export default function StudioCoberturaPage() {
    ...
    const openForm = (ctaLocation, packageSelected = null) => { track('Lead', { lead_type: 'studio_cobertura', content_name: `studio_cobertura Form — ${ctaLocation}` }); setFormCta({ ctaLocation, packageSelected }); };
        ...
        <div className="bg-surface text-on-surface font-body antialiased">
            ...
            <section className="relative w-full overflow-hidden bg-black m-0 p-0 border-0" style={{ height: "105vh" }}>
                <div className="absolute inset-0 z-0">
                    <Image src="/images/studio/mileide-mihaile/capa.webp" alt="Cobertura fotográfica de eventos em São Paulo — House Mazzutti Studio" fill priority className="object-cover object-center" sizes="100vw" />
            ...
            <section className="relative h-[769px] w-full flex items-center justify-center overflow-hidden bg-zinc-900">
                    <Image src="/images/studio/mileide-mihaile/capa.webp" alt="Cobertura fotográfica de eventos em São Paulo — House Mazzutti Studio" fill className="object-cover opacity-80" sizes="100vw" />
