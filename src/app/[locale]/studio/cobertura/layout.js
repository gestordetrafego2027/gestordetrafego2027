...
export async function generateMetadata({ params }) {
  ...
  return pageMetadata({
    ...
    image: { src: `/opengraph-image?title=${encodeURIComponent('Cobertura Fotográfica de Eventos em São Paulo')}&unit=${encodeURIComponent('Studio')}`, alt: 'Cobertura fotográfica editorial — House Mazzutti Studio', width: 1200, height: 630 },
  })
}
