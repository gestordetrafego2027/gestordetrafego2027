...
export default function StudioBookPage() {
    ...
    return (
        <div className="bg-surface text-on-surface font-body antialiased">
            ...
            <h1 className="sr-only">{t('seo_h1')}</h1>
            ...
            <section className="bg-[#f5f5f5] pt-[4rem] md:pt-[5rem] pb-[10rem] md:pb-[12rem]">
                    <div className="max-w-[1440px] mx-auto px-6 text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-20">
                            {[
                                { icon: 'psychology', title: t('servico_1_titulo'), desc: t('servico_1_desc') },
                                { icon: 'auto_awesome_motion', title: t('servico_2_titulo'), desc: t('servico_2_desc') },
                                { icon: 'movie_edit', title: t('servico_3_titulo'), desc: t('servico_3_desc') },
                                { icon: 'photo_camera', title: t('servico_4_titulo'), desc: t('servico_4_desc') },
                                { icon: 'content_cut', title: t('servico_5_titulo'), desc: t('servico_5_desc') },
                                { icon: 'diamond', title: t('servico_6_titulo'), desc: t('servico_6_desc') },
                            ].map((s, i) => (
            ...
            <section className="relative h-[769px] w-full flex items-center justify-center overflow-hidden bg-zinc-900">
                    <img alt="Reel House Mazzutti" className="absolute inset-0 w-full h-full object-cover opacity-80" src="/images/studio/marina-machado/capa.webp" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
                            <div data-aos="fade-right">
                                ...
                                <ul className="space-y-10">
                                    {[
                                        { t: t('comparative_com_1_titulo'), d: t('comparative_com_1_desc') },
                            ...
                            <div data-aos="fade-left">
                                ...
                                <ul className="space-y-10">
                                    {[
                                        { t: t('comparative_sem_1_titulo'), d: t('comparative_sem_1_desc') },
                                        { t: t('comparative_sem_2_titulo'), d: t('comparative_sem_2_desc') },
                                        { t: t('comparative_sem_3_titulo'), d: t('comparative_sem_3_desc') },
                                    ].map((i) => (
                                        <li key={i.t} className="flex items-start gap-6 opacity-50">
