      ...
      <section className="excerpt" id="trecho">
        <div className="excerpt-grid">
          ...
          <div className="excerpt-body">
            <p className="dropcap">Em janeiro de 2026, quando Lula sancionou a Lei nº 15.325 e regulamentou a profissão de &ldquo;multimídia&rdquo; no Brasil, a imprensa apelidou de Lei dos Influenciadores. A piada foi boa. A piada também esconde o que de fato aconteceu — o Estado, dois decretos depois das outras democracias, finalmente nomeou um mercado que já existia há quinze anos. O mercado da atenção.</p>
            <p>Não se chama assim. Quase nunca se chama assim. Os relatórios de mercado falam em &ldquo;creator economy&rdquo;. Os investidores falam em &ldquo;audience-driven business&rdquo;. As agências falam em &ldquo;branded content&rdquo;. Todo mundo escolhe um eufemismo. Mas o que se vende é uma coisa só — o direito de ocupar três segundos do tempo de outra pessoa.</p>
