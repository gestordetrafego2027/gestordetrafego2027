...
export const articles = {
  ...
  "exposicao-fragmentos-ita-mazzutti": {
    ...
    "sections": [
      ...
      {
        "h2": "Quando a marca vira experiência",
        "paragraphs": [
          "Um evento autoral não comunica por anúncio — comunica por vivência. E vivência, hoje, é o ativo mais difícil de copiar num mercado saturado de imagem.",
          "Fragmentos provou que uma exposição bem dirigida não decora um espaço: instala uma percepção que sobrevive à noite."
        ]
      },
      {
        "h2": "O legado de um evento bem dirigido",
        "paragraphs": [
          "O setor criativo brasileiro já responde por 3,59% do PIB, segundo a Firjan, e experiências de marca são parte central desse valor. Um evento autoral é, ao mesmo tempo, peça cultural e ativo de posicionamento.",
          "Por isso tratamos cada evento como narrativa: concepção, cenografia, imprensa e captação operando como um só organismo, do conceito ao registro."
        ]
      }
    ],
