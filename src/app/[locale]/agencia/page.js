                ...
                <section className="bg-white pt-24 pb-0 w-full mx-auto">
                    ...
                    <div className="columns-gallery-container">
                        {[
                            ...
                            { href: '/portfolio-agencia/on-take', src: '/images/agencia/on-take/capa.webp', fallback: '/images/home/banner-1.webp', label: t('pf_comunicacao'), title: 'On Take' },
                            ...
                            { href: '/portfolio-agencia/fort', src: '/images/agencia/fort/fort-negocios-imobiliarios-branding-identidade-visual-house-mazzutti-agencia-01.webp', fallback: '/images/home/banner-1.webp', label: t('pf_branding_identidade'), title: 'Fort Negócios Imobiliários' },
                            ...
                            { href: '/portfolio-agencia/luiz-jr', src: '/images/agencia/luiz-jr/luiz-jr-branding-identidade-visual-house-mazzutti-agencia-01.webp', fallback: '/images/home/banner-1.webp', label: t('pf_branding_identidade'), title: 'Luiz Jr' },
                        ].map((item, i) => (
