...
export default function AgenciaRpPage() {
    ...
    return (
        <div className="bg-surface text-on-surface font-body antialiased">
            ...
            <h1 className="sr-only">RP e Marketing Direto para Marcas — House Mazzutti Agência</h1>

            <Header variant="dark" />

            {/* HERO */}
            <section className="relative h-screen w-full overflow-hidden">
                <Image src="/images/agencia/banners/banner-2.webp" alt="RP & Marketing Direto — House Mazzutti" fill priority sizes="100vw" className="object-cover object-center" />
                ...
                <div className="relative z-10 w-full h-full flex items-center justify-center">
                    <div className="w-full max-w-[600px] flex flex-col items-center text-center px-6">
                        ...
                        <h2 className="font-headline text-3xl md:text-5xl text-white mb-8 leading-tight tracking-tight" data-aos="fade-up" data-aos-delay="200">{t('hero_titulo')}</h2>
                        <p className="font-body text-white/70 text-base md:text-lg mb-12 leading-relaxed" data-aos="fade-up" data-aos-delay="300">{t('hero_texto')}</p>
                        <button
                            type="button"
                            onClick={() => setFormOpen(true)}
                            className="font-label uppercase tracking-[0.3em] text-[11px] text-white border border-white/40 px-10 py-4 hover:bg-white hover:text-black transition-all duration-500"
            ...
            <section className="bg-[#f5f5f5] pt-[4rem] md:pt-[5rem] pb-[10rem] md:pb-[12rem]">
                <div className="max-w-[1440px] mx-auto px-6 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-20">
                        {[
                            { icon: 'newspaper', titleKey: 'servico_1_title', descKey: 'servico_1_desc' },
                            { icon: 'handshake', titleKey: 'servico_2_title', descKey: 'servico_2_desc' },
                            { icon: 'record_voice_over', titleKey: 'servico_3_title', descKey: 'servico_3_desc' },
                            { icon: 'mail', titleKey: 'servico_4_title', descKey: 'servico_4_desc' },
                            { icon: 'auto_stories', titleKey: 'servico_5_title', descKey: 'servico_5_desc' },
            ...
            <footer className="bg-white text-zinc-900 py-24 px-12 border-t-[0.5px] border-zinc-200 flex flex-col items-center w-full text-center space-y-8">
                <nav className="flex flex-wrap justify-center gap-x-12 gap-y-4 pb-12">
                    ...
                    <Link className="font-label uppercase tracking-[0.2em] text-[9px] text-zinc-400 hover:text-zinc-900 transition-colors duration-200" href="/portfolio-agencia">{t('footer_nav_portfolio')}</Link>
