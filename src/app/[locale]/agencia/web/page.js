...
export default function AgenciaWebPage() {
    ...
    const openForm = () => { track('Lead', { lead_type: 'agencia_web', content_name: 'Web Form' }); setFormOpen(true); };
        ...
        <div className="bg-surface text-on-surface font-body antialiased">
            ...
            <section className="relative w-full overflow-hidden bg-black m-0 p-0 border-0" style={{ height: "105vh" }}>
                <div className="absolute inset-0 z-0">
                    <Image src="/images/agencia/house-mazzutti/capa.webp" alt="Criação de sites em São Paulo — House Mazzutti Agência" fill priority className="object-cover object-center" sizes="100vw" />
            ...
            <section className="relative h-[769px] w-full flex items-center justify-center overflow-hidden">
                <Image src="/images/agencia/samrat/capa.webp" alt="Criação de sites em São Paulo — House Mazzutti Agência" fill className="object-cover object-center" sizes="100vw" />
