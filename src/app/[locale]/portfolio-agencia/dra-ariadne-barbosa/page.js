...
export default function DraAriadneBarbosaPage() {
    ...
    const horizontalImages = [
        "/images/agencia/dra-ariadne-barbosa/dra-ariadne-barbosa-logo-branding-manual-de-marca-identidade-visual-house-mazzutti-agencia-01.webp",
        "/images/agencia/dra-ariadne-barbosa/dra-ariadne-barbosa-logo-branding-manual-de-marca-identidade-visual-house-mazzutti-agencia-02.webp",
        ...
        "/images/agencia/dra-ariadne-barbosa/dra-ariadne-barbosa-logo-branding-manual-de-marca-identidade-visual-house-mazzutti-agencia-04.webp",
        "/images/agencia/dra-ariadne-barbosa/dra-ariadne-barbosa-logo-branding-manual-de-marca-identidade-visual-house-mazzutti-agencia-05.webp",
        "/images/agencia/dra-ariadne-barbosa/dra-ariadne-barbosa-logo-branding-manual-de-marca-identidade-visual-house-mazzutti-agencia-06.webp"
    ];
    ...
    return (
        <div className="bg-surface text-on-surface antialiased">
                    ...
                    <div className="lg:w-2/3 flex flex-col gap-8">
                        {verticalImages.map((src, i) => (
                            <div key={i} className="image-anim relative overflow-hidden group cursor-pointer" onClick={() => openImg(i)} style={{height:'600px'}}>
                                <Image alt="Dra. Ariadne Barbosa — branding House Mazzutti" src={src} fill sizes="(max-width: 768px) 100vw, 66vw" quality={i===0?85:80} loading={i===0?undefined:"lazy"} priority={i===0?true:undefined} className="w-full h-full object-cover transition-all duration-700" />
                            </div>
                        ))}
                        {horizontalImages.map((src, i) => (
                            <div key={i} className="image-anim relative overflow-hidden group cursor-pointer" onClick={() => openImg(verticalImages.length + i)} style={{aspectRatio:'16/9'}}>
                                <Image alt="Dra. Ariadne Barbosa — identidade visual House Mazzutti" src={src} fill sizes="100vw" quality={80} loading={verticalImages.length===0 && i===0 ? undefined : "lazy"} priority={verticalImages.length===0 && i===0 ? true : undefined} className="object-cover w-full transition-all duration-700" />
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                <p className="info-col-anim font-inter text-[10px] uppercase tracking-[0.2em] text-on-surface-variant">Logo, Branding e Manual de Marca</p>
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Dra. Ariadne Barbosa</h1>
                            </div>
                            <div className="h-px w-12 bg-outline-variant/30"></div>
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                &quot;Cuidado é uma forma de presença. Discreta, precisa, humana.&quot;
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-8 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-xs text-on-surface-variant leading-relaxed">
                                    A marca da Dra. Ariadne Barbosa nasceu do equilíbrio entre técnica e acolhimento. Logo, identidade visual e manual de marca foram desenhados com delicadeza e precisão — paleta serena, tipografia leve e um sistema coeso que traduz autoridade clínica sem abrir mão da humanidade.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <PortfolioVideo unit="agencia" slug="dra-ariadne-barbosa" />

            <PortfolioCTA businessUnit="agencia" projectSlug="dra-ariadne-barbosa" />
