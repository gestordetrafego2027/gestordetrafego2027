                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    <div className="lg:w-2/3 flex flex-col gap-8">
                        ...
                        {horizontalImages.map((src, i) => (
                            <div key={i} className="image-anim relative overflow-hidden group cursor-pointer" onClick={() => openImg(5 + i)} style={{aspectRatio:'16/9'}}>
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Antes da forma, a intenção. Antes da execução, a clareza."
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-8 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-xs text-on-surface-variant leading-relaxed">
                                    Marca não é logo. É um sistema de decisões. A Agência da House Mazzutti opera nesse plano: posicionamento, narrativa, identidade visual e presença — articulados com intenção, do conceito à materialização.
                                </p>
                            </div>
                        </div>
                    </div>
