                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Mabdo</h1>
                            </div>
                            <div className="h-px w-12 bg-outline-variant/30"></div>
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Presença não se grita. Se constrói — gesto a gesto."
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-8 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-xs text-on-surface-variant leading-relaxed">
                                    Mabdo pedia uma marca à altura do produto — sóbria, contemporânea, sem ruído. O sistema visual foi construído sobre tipografia editorial, paleta monocromática e uma linguagem que privilegia o silêncio antes do gesto.
                                </p>
                            </div>
                        </div>
                    </div>
