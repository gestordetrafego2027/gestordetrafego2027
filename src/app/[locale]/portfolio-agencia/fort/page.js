...
export default function FortPage() {
    ...
    const horizontalImages = [
        "/images/agencia/fort/fort-negocios-imobiliarios-branding-identidade-visual-house-mazzutti-agencia-01.webp",
        "/images/agencia/fort/fort-negocios-imobiliarios-branding-identidade-visual-house-mazzutti-agencia-02.webp",
        "/images/agencia/fort/fort-negocios-imobiliarios-branding-identidade-visual-house-mazzutti-agencia-03.webp",
        "/images/agencia/fort/fort-negocios-imobiliarios-branding-identidade-visual-house-mazzutti-agencia-04.webp",
        "/images/agencia/fort/fort-negocios-imobiliarios-branding-identidade-visual-house-mazzutti-agencia-05.webp",
        "/images/agencia/fort/fort-negocios-imobiliarios-branding-identidade-visual-house-mazzutti-agencia-06.webp"
    ];
    ...
    return (
        <div className="bg-surface text-on-surface antialiased">
                    ...
                    <div className="lg:w-2/3 flex flex-col gap-8">
                        {verticalImages.map((src, i) => (
                            <div key={i} className="image-anim relative overflow-hidden group cursor-pointer" onClick={() => openImg(i)} style={{height:'600px'}}>
                                <Image alt="Fort Negócios Imobiliários — branding House Mazzutti" src={src} fill sizes="(max-width: 768px) 100vw, 66vw" quality={i===0?85:80} loading={i===0?undefined:"lazy"} priority={i===0?true:undefined} className="w-full h-full object-cover transition-all duration-700" />
                            </div>
                        ))}
                        {horizontalImages.map((src, i) => (
                            <div key={i} className="image-anim relative overflow-hidden group cursor-pointer" onClick={() => openImg(verticalImages.length + i)} style={{aspectRatio:'16/9'}}>
                                <Image alt="Fort Negócios Imobiliários — identidade visual House Mazzutti" src={src} fill sizes="100vw" quality={80} loading={verticalImages.length===0 && i===0 ? undefined : "lazy"} priority={verticalImages.length===0 && i===0 ? true : undefined} className="object-cover w-full transition-all duration-700" />
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Fort Negócios Imobiliários</h1>
                            </div>
                            <div className="h-px w-12 bg-outline-variant/30"></div>
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                &quot;Solidez não se promete. Se demonstra — em cada detalhe.&quot;
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-8 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-xs text-on-surface-variant leading-relaxed">
                                    A Fort pedia uma marca à altura da confiança que entrega: firme, sóbria e contemporânea. Construímos um sistema visual sobre tipografia sólida, acabamento em prata e uma linguagem que comunica permanência antes de qualquer promessa — o tom certo para o mercado imobiliário de alto padrão.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <PortfolioVideo unit="agencia" slug="fort" />

            <PortfolioCTA businessUnit="agencia" projectSlug="fort" />
