...
export default function ThaisiDiasPage() {
    ...
    const images = [
      '/images/studio/thaisi-dias/1.webp',
      '/images/studio/thaisi-dias/2.webp',
      '/images/studio/thaisi-dias/3.webp',
      '/images/studio/thaisi-dias/4.webp',
      '/images/studio/thaisi-dias/5.webp',
    ]
