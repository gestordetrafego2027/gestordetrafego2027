...
export default function FrancineMassocoPage() {
    ...
    const images = [
      '/images/studio/francine-massoco/1.webp',
      '/images/studio/francine-massoco/2.webp',
      '/images/studio/francine-massoco/3.webp',
      '/images/studio/francine-massoco/4.webp',
      '/images/studio/francine-massoco/5.webp',
    ]
