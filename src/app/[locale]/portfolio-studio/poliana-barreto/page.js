...
export default function PolianaBarretoPage() {
    ...
    const images = [
      '/images/studio/poliana-barreto/1.webp',
      '/images/studio/poliana-barreto/2.webp',
      '/images/studio/poliana-barreto/3.webp',
      '/images/studio/poliana-barreto/4.webp',
      '/images/studio/poliana-barreto/5.webp',
    ]
