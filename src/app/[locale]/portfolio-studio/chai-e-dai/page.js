...
export default function ChaiEDaiPage() {
    ...
    const images = [
      '/images/studio/chai-e-dai/1.webp',
      '/images/studio/chai-e-dai/2.webp',
      '/images/studio/chai-e-dai/3.webp',
      '/images/studio/chai-e-dai/4.webp',
      '/images/studio/chai-e-dai/5.webp',
      '/images/studio/chai-e-dai/6.webp',
    ]
    ...
    return (
        <div className="bg-surface text-on-surface antialiased">
                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => openImg(0)} className="cursor-pointer">
                            <Image alt="Chai e Dai - Book Studio House Mazzutti - Foto 1" style={{objectPosition: 'top'}} src="/images/studio/chai-e-dai/1.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg(1)} className="cursor-pointer">
                            <Image alt="Chai e Dai - Book Studio House Mazzutti - Foto 2" style={{objectPosition: 'top'}} src="/images/studio/chai-e-dai/2.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg(2)} className="cursor-pointer">
                            <Image alt="Chai e Dai - Book Studio House Mazzutti - Foto 3" style={{objectPosition: 'top'}} src="/images/studio/chai-e-dai/3.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg(3)} className="cursor-pointer">
                            <Image alt="Chai e Dai - Book Studio House Mazzutti - Foto 4" style={{objectPosition: 'top'}} src="/images/studio/chai-e-dai/4.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg(4)} className="cursor-pointer">
                            <Image alt="Chai e Dai - Book Studio House Mazzutti - Foto 5" style={{objectPosition: 'top'}} src="/images/studio/chai-e-dai/5.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg(5)} className="cursor-pointer">
                            <Image alt="Chai e Dai - Book Studio House Mazzutti - Foto 6" style={{objectPosition: 'top'}} src="/images/studio/chai-e-dai/6.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Chai e Dai</h1>
                            </div>
                            <div className="h-px w-12 bg-outline-variant/30"></div>
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Duas presenças no mesmo quadro — ou duas leituras no mesmo eixo?"
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Book duplo construído em dois eixos visuais paralelos — cada uma com a sua leitura, ambas sob a mesma assinatura editorial. Sequência montada a partir do contraste, com ritmo de produção desenhado para sustentar conjunto e individualidade.`}
                                </p>
            ...
            <PortfolioVideo unit="studio" slug="chai-e-dai" />

            <PortfolioCTA businessUnit="studio" projectSlug="chai-e-dai" />
