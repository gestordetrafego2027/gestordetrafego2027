                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => openImg('/images/studio/chai-e-dai/1.webp')} className="cursor-pointer">
                          ...
                          <div onClick={() => openImg('/images/studio/chai-e-dai/2.webp')} className="cursor-pointer">
                          ...
                          <div onClick={() => openImg('/images/studio/chai-e-dai/3.webp')} className="cursor-pointer">
                          ...
                          <div onClick={() => openImg('/images/studio/chai-e-dai/4.webp')} className="cursor-pointer">
                          ...
                          <div onClick={() => openImg('/images/studio/chai-e-dai/5.webp')} className="cursor-pointer">
                          ...
                          <div onClick={() => openImg('/images/studio/chai-e-dai/6.webp')} className="cursor-pointer">
