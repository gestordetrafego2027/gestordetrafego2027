                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => openImg('/images/studio/jessica-bittelbrun/1.webp')} className="cursor-pointer">
                            <Image alt="Jessica Bittelbrun - Book Studio House Mazzutti - Foto 1" style={{objectPosition: 'top'}} src="/images/studio/jessica-bittelbrun/1.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/jessica-bittelbrun/2.webp')} className="cursor-pointer">
                            <Image alt="Jessica Bittelbrun - Book Studio House Mazzutti - Foto 2" style={{objectPosition: 'top'}} src="/images/studio/jessica-bittelbrun/2.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/jessica-bittelbrun/3.webp')} className="cursor-pointer">
                            <Image alt="Jessica Bittelbrun - Book Studio House Mazzutti - Foto 3" style={{objectPosition: 'top'}} src="/images/studio/jessica-bittelbrun/3.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/jessica-bittelbrun/4.webp')} className="cursor-pointer">
                            <Image alt="Jessica Bittelbrun - Book Studio House Mazzutti - Foto 4" style={{objectPosition: 'top'}} src="/images/studio/jessica-bittelbrun/4.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/jessica-bittelbrun/5.webp')} className="cursor-pointer">
                            <Image alt="Jessica Bittelbrun - Book Studio House Mazzutti - Foto 5" style={{objectPosition: 'top'}} src="/images/studio/jessica-bittelbrun/5.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/jessica-bittelbrun/6.webp')} className="cursor-pointer">
                            <Image alt="Jessica Bittelbrun - Book Studio House Mazzutti - Foto 6" style={{objectPosition: 'top'}} src="/images/studio/jessica-bittelbrun/6.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/jessica-bittelbrun/7.webp')} className="cursor-pointer">
                            <Image alt="Jessica Bittelbrun - Book Studio House Mazzutti - Foto 7" style={{objectPosition: 'top'}} src="/images/studio/jessica-bittelbrun/7.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Jessica Bittelbrun</h1>
                            </div>
