...
export default function JessicaBittelbrunPage() {
    ...
    const images = [
      '/images/studio/jessica-bittelbrun/1.webp',
      '/images/studio/jessica-bittelbrun/2.webp',
      '/images/studio/jessica-bittelbrun/3.webp',
      '/images/studio/jessica-bittelbrun/4.webp',
      '/images/studio/jessica-bittelbrun/5.webp',
      '/images/studio/jessica-bittelbrun/6.webp',
      '/images/studio/jessica-bittelbrun/7.webp',
    ]
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Três versões num único book — qual delas é a sua?"
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Sessão capaz de revelar três versões em um único material — presença comercial direta, sofisticação editorial e leveza de fashion film. Material multifacetado entregue com a precisão que abre portas em mais de uma direção.`}
                                </p>
