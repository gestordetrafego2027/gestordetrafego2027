...
export default function IasmimPage() {
    ...
    const images = [
      '/images/studio/iasmim/1.webp',
      '/images/studio/iasmim/2.webp',
      '/images/studio/iasmim/3.webp',
      '/images/studio/iasmim/4.webp',
      '/images/studio/iasmim/5.webp',
    ]
                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => openImg(0)} className="cursor-pointer">
                            <Image alt="Iasmim - Book Studio House Mazzutti - Foto 1" style={{objectPosition: 'top'}} src="/images/studio/iasmim/1.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg(1)} className="cursor-pointer">
                            <Image alt="Iasmim - Book Studio House Mazzutti - Foto 2" style={{objectPosition: 'top'}} src="/images/studio/iasmim/2.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg(2)} className="cursor-pointer">
                            <Image alt="Iasmim - Book Studio House Mazzutti - Foto 3" style={{objectPosition: 'top'}} src="/images/studio/iasmim/3.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg(3)} className="cursor-pointer">
                            <Image alt="Iasmim - Book Studio House Mazzutti - Foto 4" style={{objectPosition: 'top'}} src="/images/studio/iasmim/4.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg(4)} className="cursor-pointer">
                            <Image alt="Iasmim - Book Studio House Mazzutti - Foto 5" style={{objectPosition: 'top'}} src="/images/studio/iasmim/5.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Iasmim</h1>
                            </div>
                            <div className="h-px w-12 bg-outline-variant/30"></div>
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Sustentar presença sem performar — quem consegue?"
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Book em blocos de mercado distintos, cada um com acabamento próprio. Fashion film amplia o repertório com narrativa. Apresentação completa — editorial, comercial, narrativa — desenhada para circular em casting de alto nível.`}
                                </p>
