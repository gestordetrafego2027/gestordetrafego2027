...
export default function MarjorieRossiPage() {
    ...
    const images = [
      '/images/studio/marjorie-rossi/1.webp',
      '/images/studio/marjorie-rossi/2.webp',
      '/images/studio/marjorie-rossi/3.webp',
      '/images/studio/marjorie-rossi/4.webp',
      '/images/studio/marjorie-rossi/5.webp',
      '/images/studio/marjorie-rossi/6.webp',
    ]
