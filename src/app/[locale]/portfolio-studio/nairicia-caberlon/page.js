...
export default function NarciaCaberlonPage() {
    ...
    const images = [
      '/images/studio/nairicia-caberlon/1.webp',
      '/images/studio/nairicia-caberlon/2.webp',
      '/images/studio/nairicia-caberlon/3.webp',
      '/images/studio/nairicia-caberlon/4.webp',
      '/images/studio/nairicia-caberlon/5.webp',
      '/images/studio/nairicia-caberlon/6.webp',
      '/images/studio/nairicia-caberlon/7.webp',
    ]
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Há momentos que pedem mais do que registro — pedem direção."
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Ensaio Hall of Fame conduzido como narrativa visual — cada quadro respondendo a uma camada da trajetória. Beauty e vídeo desenhados para que nada competisse com a protagonista. Material que se torna parte da própria história, sem caricatura.`}
                                </p>
