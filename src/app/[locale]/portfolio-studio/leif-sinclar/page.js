                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => openImg('/images/studio/leif-sinclar/1.jpg')} className="cursor-pointer">
                            <Image alt="Foto 1" style={{objectPosition: 'top'}} src="/images/studio/leif-sinclar/1.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leif-sinclar/2.jpg')} className="cursor-pointer">
                            <Image alt="Foto 2" style={{objectPosition: 'top'}} src="/images/studio/leif-sinclar/2.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leif-sinclar/3.jpg')} className="cursor-pointer">
                            <Image alt="Foto 3" src="/images/studio/leif-sinclar/3.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leif-sinclar/4.jpg')} className="cursor-pointer">
                            <Image alt="Foto 4" src="/images/studio/leif-sinclar/4.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leif-sinclar/5.jpg')} className="cursor-pointer">
                            <Image alt="Foto 5" src="/images/studio/leif-sinclar/5.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
