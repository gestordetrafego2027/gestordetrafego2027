...
export default function LeifSinclarPage() {
    ...
    const images = [
      '/images/studio/leif-sinclar/1.webp',
      '/images/studio/leif-sinclar/2.webp',
      '/images/studio/leif-sinclar/3.webp',
      '/images/studio/leif-sinclar/4.webp',
      '/images/studio/leif-sinclar/5.webp',
      '/images/studio/leif-sinclar/6.webp',
      '/images/studio/leif-sinclar/7.webp',
    ]
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Masculinidade adulta não pede performance — pede contenção."
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Ensaio masculino editorial em narrativa adulta e contemporânea — postura, olhar, silêncio. Beauty, vídeo e luz nesse mesmo eixo. Banco editorial para redes próprias, apresentação institucional e composição de portfólio profissional.`}
                                </p>
