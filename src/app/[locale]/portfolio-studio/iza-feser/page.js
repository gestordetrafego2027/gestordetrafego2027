...
export default function IzaFeserPage() {
    ...
    const images = [
      '/images/studio/iza-feser/1.webp',
      '/images/studio/iza-feser/2.webp',
      '/images/studio/iza-feser/3.webp',
      '/images/studio/iza-feser/4.webp',
      '/images/studio/iza-feser/5.webp',
    ]
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "O olhar é onde a leitura começa."
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Renovação dirigida em torno do olhar — ponto forte de leitura. Beauty e vídeo alinhados para que essa força não se diluísse. Fashion film amplia repertório com camada de movimento, material com mesma autoridade em casting editorial e comercial.`}
                                </p>
