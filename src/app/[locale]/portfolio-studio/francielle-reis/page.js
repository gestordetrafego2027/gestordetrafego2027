...
export default function FrancielleReisPage() {
    ...
    const images = [
      '/images/studio/francielle-reis/1.webp',
      '/images/studio/francielle-reis/2.webp',
      '/images/studio/francielle-reis/3.webp',
      '/images/studio/francielle-reis/4.webp',
      '/images/studio/francielle-reis/5.webp',
    ]
