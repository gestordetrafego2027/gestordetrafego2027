                    ...
                    <div className="lg:w-2/3">
                        <div className="images-grid">
                            <div className="relative overflow-hidden group">
                                <Image alt="House Mazzutti Studio" src="/images/produtora/moda/toli/1.webp" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="object-cover transition-all duration-700" />
                            </div>
                            <div className="relative overflow-hidden group">
                                <Image alt="House Mazzutti Studio" src="/images/produtora/moda/toli/2.webp" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="object-cover transition-all duration-700" />
                            </div>
                            <div className="relative overflow-hidden group">
                                <Image alt="House Mazzutti Studio" src="/images/produtora/moda/toli/3.webp" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="object-cover transition-all duration-700" />
                            </div>
                            <div className="relative overflow-hidden group">
                                <Image alt="House Mazzutti Studio" src="/images/produtora/moda/toli/4.webp" fill sizes="(max-width: 768px) 100vw, 33vw" quality={80} loading="lazy" className="object-cover transition-all duration-700" />
                            </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
