...
export default function JamileCarolinePage() {
    ...
    const images = [
      '/images/studio/jamile-caroline/1.webp',
      '/images/studio/jamile-caroline/2.webp',
      '/images/studio/jamile-caroline/3.webp',
      '/images/studio/jamile-caroline/4.webp',
      '/images/studio/jamile-caroline/5.webp',
      '/images/studio/jamile-caroline/6.webp',
    ]
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Bom book não vende — instala percepção."
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Material de reposicionamento no radar de seleção — presença firme, leitura de mercado clara, fashion film com ritmo próprio. Beauty, vídeo e estilo costurados em uma só linha narrativa, ferramenta de carreira e não portfólio decorativo.`}
                                </p>
