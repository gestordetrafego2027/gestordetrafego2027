                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => openImg('/images/studio/emanuelly-terres/1.jpg')} className="cursor-pointer">
                            <Image alt="Emanuelly Terres - Book Studio House Mazzutti - Foto 1" style={{objectPosition: 'top'}} src="/images/studio/emanuelly-terres/1.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/emanuelly-terres/2.jpg')} className="cursor-pointer">
                            <Image alt="Emanuelly Terres - Book Studio House Mazzutti - Foto 2" style={{objectPosition: 'top'}} src="/images/studio/emanuelly-terres/2.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/emanuelly-terres/3.jpg')} className="cursor-pointer">
                            <Image alt="Emanuelly Terres - Book Studio House Mazzutti - Foto 3" style={{objectPosition: 'top'}} src="/images/studio/emanuelly-terres/3.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/emanuelly-terres/4.jpg')} className="cursor-pointer">
                            <Image alt="Emanuelly Terres - Book Studio House Mazzutti - Foto 4" style={{objectPosition: 'top'}} src="/images/studio/emanuelly-terres/4.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
