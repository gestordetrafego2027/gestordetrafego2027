...
export default function PatriciaMarafonPage() {
    ...
    const images = [
      '/images/studio/patricia-marafon/1.webp',
      '/images/studio/patricia-marafon/2.webp',
      '/images/studio/patricia-marafon/3.webp',
      '/images/studio/patricia-marafon/4.webp',
      '/images/studio/patricia-marafon/5.webp',
      '/images/studio/patricia-marafon/6.webp',
      '/images/studio/patricia-marafon/7.webp',
    ]
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Leitura adulta começa por economizar o gesto, não a presença."
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Book de leitura adulta sem cair em demonstração, sem economizar presença. Beauty e vídeo em torno do mesmo eixo. Fashion film fechando com camada cinematográfica — material que faz o trabalho antes do briefing começar.`}
                                </p>
