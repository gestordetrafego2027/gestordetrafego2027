...
export default function BrendaMattosPage() {
    ...
    const images = [
      '/images/studio/brenda-mattos/1.webp',
      '/images/studio/brenda-mattos/2.webp',
      '/images/studio/brenda-mattos/3.webp',
      '/images/studio/brenda-mattos/4.webp',
      '/images/studio/brenda-mattos/5.webp',
      '/images/studio/brenda-mattos/6.webp',
      '/images/studio/brenda-mattos/7.webp',
    ]
