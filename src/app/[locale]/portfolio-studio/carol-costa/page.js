...
export default function CarolCostaPage() {
    ...
    const images = [
      '/images/studio/carol-costa/1.webp',
      '/images/studio/carol-costa/2.webp',
      '/images/studio/carol-costa/3.webp',
      '/images/studio/carol-costa/4.webp',
      '/images/studio/carol-costa/5.webp',
      '/images/studio/carol-costa/6.webp',
    ]
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Vínculo afetivo vira narrativa quando há direção."
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Ensaio com pets em narrativa íntima, sem composição artificial — luz, set e ritmo ajustados para presença espontânea. Retrato de família contemporâneo, denso e bem direcionado, longe do formato decorativo.`}
                                </p>
