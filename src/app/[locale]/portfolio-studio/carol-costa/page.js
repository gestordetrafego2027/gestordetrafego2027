...
export default function CarolCostaPage() {
    ...
    return (
        <div className="bg-surface text-on-surface antialiased">
                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => openImg('/images/studio/carol-costa/1.webp')} className="cursor-pointer">
                            <Image alt="Carol Costa - Ensaio Pessoal House Mazzutti - Foto 1" style={{objectPosition: 'top'}} src="/images/studio/carol-costa/1.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/carol-costa/2.webp')} className="cursor-pointer">
                            <Image alt="Carol Costa - Ensaio Pessoal House Mazzutti - Foto 2" style={{objectPosition: 'top'}} src="/images/studio/carol-costa/2.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/carol-costa/3.webp')} className="cursor-pointer">
                            <Image alt="Carol Costa - Ensaio Pessoal House Mazzutti - Foto 3" style={{objectPosition: 'top'}} src="/images/studio/carol-costa/3.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/carol-costa/4.webp')} className="cursor-pointer">
                            <Image alt="Carol Costa - Ensaio Pessoal House Mazzutti - Foto 4" style={{objectPosition: 'top'}} src="/images/studio/carol-costa/4.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/carol-costa/5.webp')} className="cursor-pointer">
                            <Image alt="Carol Costa - Ensaio Pessoal House Mazzutti - Foto 5" style={{objectPosition: 'top'}} src="/images/studio/carol-costa/5.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/carol-costa/6.webp')} className="cursor-pointer">
                            <Image alt="Carol Costa - Ensaio Pessoal House Mazzutti - Foto 6" style={{objectPosition: 'top'}} src="/images/studio/carol-costa/6.webp" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
            ...
            <PortfolioVideo unit="studio" slug="carol-costa" />

            <PortfolioCTA businessUnit="studio" projectSlug="carol-costa" />
