...
export default function PaulaAssunoPage() {
    ...
    const images = [
      '/images/studio/paula-assuncao/1.webp',
      '/images/studio/paula-assuncao/2.webp',
      '/images/studio/paula-assuncao/3.webp',
      '/images/studio/paula-assuncao/4.webp',
      '/images/studio/paula-assuncao/5.webp',
      '/images/studio/paula-assuncao/6.webp',
      '/images/studio/paula-assuncao/7.webp',
      '/images/studio/paula-assuncao/8.webp',
    ]
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Trabalhar percepção antes da disputa muda o jogo."
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Ensaio a partir de referências editoriais internacionais para concurso — beauty pensado para sustentar autoridade e doçura na mesma imagem, luz desenhada para retrato editorial. Ferramenta de competição, não apenas registro.`}
                                </p>
