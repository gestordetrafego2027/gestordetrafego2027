...
export default function FernandaCostasPage() {
    ...
    const images = [
      '/images/studio/fernanda-costas/1.webp',
      '/images/studio/fernanda-costas/2.webp',
      '/images/studio/fernanda-costas/3.webp',
      '/images/studio/fernanda-costas/4.webp',
    ]
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "Sustentar presença adulta sem rigidez é direção."
                            </p>
