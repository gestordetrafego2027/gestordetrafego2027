...
export default function DeboraPantaglionePage() {
    ...
    const images = [
      '/images/studio/debora-pantaglione/1.webp',
      '/images/studio/debora-pantaglione/2.webp',
      '/images/studio/debora-pantaglione/3.webp',
      '/images/studio/debora-pantaglione/4.webp',
      '/images/studio/debora-pantaglione/5.webp',
      '/images/studio/debora-pantaglione/6.webp',
      '/images/studio/debora-pantaglione/7.webp',
      '/images/studio/debora-pantaglione/8.webp',
    ]
                    ...
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            ...
                            <p className="info-col-anim font-newsreader text-2xl italic leading-relaxed text-on-surface-variant">
                                "O que muda em você precisa mudar na sua imagem."
                            </p>
                            ...
                            <div className="info-col-anim bg-white/50 p-8 mt-4 border border-outline-variant/10">
                                ...
                                <p className="font-inter text-sm text-on-surface-variant leading-relaxed">
                                    {`Renovação de book em transição de fase profissional — partindo da estrutura óssea e da força de olhar. Set fluido, beauty e estilo conversando em uma só linha, leitura editorial que sustenta a próxima etapa sem inflar e sem suavizar.`}
                                </p>
