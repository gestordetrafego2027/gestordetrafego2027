...
export default function MarinaMachadoPage() {
    ...
    const images = [
      '/images/studio/marina-machado/1.webp',
      '/images/studio/marina-machado/2.webp',
      '/images/studio/marina-machado/3.webp',
      '/images/studio/marina-machado/4.webp',
      '/images/studio/marina-machado/5.webp',
      '/images/studio/marina-machado/6.webp',
    ]
