...
export default function ProdutoraInstitucionalPage() {
    ...
    const openForm = (ctaLocation, packageSelected = null) => { track('Lead', { lead_type: 'produtora_institucional', content_name: `produtora_institucional Form — ${ctaLocation}` }); setFormCta({ ctaLocation, packageSelected }); };
    ...
    return (
        <div className="bg-surface text-on-surface font-body antialiased">
            ...
            <section className="relative w-full overflow-hidden bg-primary m-0 p-0 border-0" style={{ height: "105vh" }}>
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        alt="Vídeo institucional em São Paulo — House Mazzutti Produtora"
                        fill
                        priority
            ...
            <section className="relative h-[769px] w-full flex items-center justify-center overflow-hidden bg-zinc-900">
                    <Image src="/images/produtora/institucional/sense-hotel/capa.webp" alt="Vídeo institucional em São Paulo — House Mazzutti Produtora" fill priority className="object-cover opacity-80" sizes="100vw" />
