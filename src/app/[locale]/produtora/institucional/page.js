...
export default function ProdutoraInstitucionalPage() {
    ...
    return (
        <div className="bg-surface text-on-surface font-body antialiased">
            ...
            <meta name="description" content="Conteúdo institucional com estratégia: vídeos corporativos, vídeos explicativos, treinamentos e cobertura de eventos para fortalecer posicionamento e autoridade." />
            ...
            <section className="relative w-full overflow-hidden bg-primary m-0 p-0 border-0" style={{ height: "105vh" }}>
                ...
                <div className="relative z-10 h-full flex flex-col justify-center px-12 md:pl-48">
                    <div className="max-w-3xl">
                        <span className="text-caption text-white/70 mb-6 block" data-aos="fade-up" data-aos-delay="100">VÍDEO INSTITUCIONAL</span>
                        ...
                        <p className="text-body text-white/80 mb-12 measure-editorial" data-aos="fade-up" data-aos-delay="300">
                            Produção audiovisual institucional de alto padrão para empresas e profissionais que buscam projetar autoridade, confiança e excelência através da imagem.
                        </p>
                        ...
                        <div className="relative aspect-square group overflow-hidden bg-black">
                            ...
                            <div className="absolute inset-0 bg-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center">
                                <div className="bg-black/60 w-[86%] aspect-square flex flex-col items-center justify-center">
                                    ...
                                    <span className="text-white font-headline text-lg italic">Institucional</span>
                                </div>
                            </div>
                        </div>
                        <div className="relative aspect-square group overflow-hidden bg-black">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-4 mb-12">
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Vídeo institucional
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Direção criativa
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Entrega digital
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div className="p-12 border border-zinc-100 flex flex-col justify-between h-full bg-white transition-all duration-300 hover:bg-black hover:text-white hover:scale-[1.02] group relative overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-4 mb-12">
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Vídeo institucional + explicativo
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Case de sucesso
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Banco de imagem
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div className="p-12 border border-surface-container-high flex flex-col justify-between h-full bg-white transition-all duration-300 hover:bg-black hover:text-white hover:scale-[1.02] group" data-aos="fade-up" data-aos-delay="300">
                                <div>
                                    ...
                                    <ul className="space-y-4 mb-12">
                                        ...
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Cobertura de eventos
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                                            <span className="material-symbols-outlined text-lg" data-icon="check">check</span> Treinamento
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-on-surface-variant group-hover:text-white/80">
                            ...
                            <div data-aos="fade-right">
                                ...
                                <ul className="space-y-10">
                                    <li className="flex items-start gap-6">
                                        ...
                                        <div>
                                            <p className="font-headline text-lg mb-2">Presença Institucional Forte</p>
                                            <p className="text-white/50 text-sm">Empresa mais profissional, confiável e bem posicionada.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="check_circle">check_circle</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Mensagem com Clareza</p>
                                            <p className="text-white/50 text-sm">Conteúdo que explica valor e sustenta autoridade.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="check_circle">check_circle</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Ativos Reais de Crescimento</p>
                                            <p className="text-white/50 text-sm">Material coerente para site, redes e comunicação.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul className="space-y-10">
                                    <li className="flex items-start gap-6 opacity-40">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-white/50 text-sm">Mensagem fraca e baixa percepção de valor no mercado.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6 opacity-40">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="cancel">cancel</span>
                                        <div>
                                            <p className="font-headline text-lg mb-2">Comunicação Inconsistente</p>
                                            <p className="text-white/50 text-sm">Empresa que parece menor do que realmente é.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-6 opacity-40">
                                        <span className="material-symbols-outlined text-white pt-1" data-icon="cancel">cancel</span>
                                        <div>
                                            ...
                                            <p className="text-white/50 text-sm">Crescimento limitado por falta de presença clara.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
