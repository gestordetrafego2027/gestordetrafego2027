    ...
    return (
        <div className="bg-surface text-on-surface font-body antialiased">
            ...
            <section className="relative h-[769px] w-full flex items-center justify-center overflow-hidden bg-zinc-900">
                    <img alt="Vídeo institucional — House Mazzutti" className="absolute inset-0 w-full h-full object-cover opacity-80" src="/images/produtora/institucional/sense-hotel/capa.webp" />
