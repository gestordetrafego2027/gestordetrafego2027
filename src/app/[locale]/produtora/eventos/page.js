...
export default function ProdutoraEventosPage() {
    ...
    const openForm = (ctaLocation) => { track('Lead', { lead_type: 'produtora_eventos', content_name: `Eventos Form — ${ctaLocation}` }); setFormCta({ ctaLocation }); };
    ...
    return (
        <div className="bg-surface text-on-surface font-body antialiased">
            ...
            <h1 className="sr-only">Cobertura e Produção de Eventos em São Paulo — House Mazzutti</h1>
            ...
            <section className="relative w-full overflow-hidden bg-black m-0 p-0 border-0" style={{ height: "105vh" }}>
                <div className="absolute inset-0 z-0">
                    <Image
                        src="/images/produtora/banners/banner-3.webp"
                        alt="Produção e cobertura de eventos em São Paulo — House Mazzutti Produtora"
                        fill priority
            ...
            <section className="bg-[#f5f5f5] pt-[4rem] md:pt-[5rem] pb-[10rem] md:pb-[12rem]">
                <div className="max-w-[1440px] mx-auto px-6 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-20">
                        {[
                            { icon: 'photo_camera', titleKey: 'servico_1_title', descKey: 'servico_1_desc' },
                            { icon: 'videocam', titleKey: 'servico_2_title', descKey: 'servico_2_desc' },
                            { icon: 'live_tv', titleKey: 'servico_3_title', descKey: 'servico_3_desc' },
                            { icon: 'flight', titleKey: 'servico_4_title', descKey: 'servico_4_desc' },
                            { icon: 'auto_awesome_motion', titleKey: 'servico_5_title', descKey: 'servico_5_desc' },
            ...
            {/* QUOTE */}
            <section className="relative py-40 md:py-48 w-full flex items-center justify-center overflow-hidden bg-zinc-900">
                <Image src="/images/produtora/banners/banner-3.webp" alt="Eventos com registro editorial em São Paulo — House Mazzutti Produtora" fill className="object-cover opacity-40" sizes="100vw" />
