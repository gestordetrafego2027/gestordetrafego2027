...
export default function ProdutoraDirecaoPage() {
    ...
    return (
        <div className="bg-surface text-on-surface font-body antialiased">
            ...
            <h1 className="sr-only">Direção e Criação Estratégica para Campanhas e Marcas — House Mazzutti</h1>
            ...
            <section className="relative w-full overflow-hidden bg-black m-0 p-0 border-0" style={{ height: "105vh" }}>
                <div className="absolute inset-0 z-0">
                    <Image
                        src="/images/produtora/banners/banner-2.webp"
                        alt="Direção criativa em São Paulo — House Mazzutti Produtora"
                        fill priority
                ...
                <div className="max-w-[1440px] mx-auto px-6 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-20">
                        {[
                            ...
                            { icon: 'photo_camera', titleKey: 'servico_3_title', descKey: 'servico_3_desc' },
                            { icon: 'home_work', titleKey: 'servico_4_title', descKey: 'servico_4_desc' },
                            { icon: 'edit_note', titleKey: 'servico_5_title', descKey: 'servico_5_desc' },
            ...
            <section className="relative py-40 md:py-48 w-full flex items-center justify-center overflow-hidden bg-zinc-900">
                <Image src="/images/produtora/banners/banner-2.webp" alt="Direção de imagem em São Paulo — House Mazzutti Produtora" fill className="object-cover opacity-40" sizes="100vw" />
