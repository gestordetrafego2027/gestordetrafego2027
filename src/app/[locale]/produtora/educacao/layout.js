...
import {educacaoServiceSchema, educacaoFaqSchema, breadcrumbSchema, speakableSchema} from '@/lib/seo/schemas'
...
export default function Layout({children}) {
  ...
  const speakable = speakableSchema(`${brand.url}/pt/produtora/educacao/`, ['h1', '.hero-title', '.hero-description', '.speakable'])
  return (
    <>
