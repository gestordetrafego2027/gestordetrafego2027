...
export default function ProdutoraEducacaoPage() {
    ...
    return (
        <div className="bg-surface text-on-surface font-body antialiased">
            ...
            <h1 className="sr-only">Produção de Conteúdo Educacional — Videoaulas e Treinamentos Corporativos | House Mazzutti</h1>
            ...
            <section className="bg-[#f5f5f5] pt-[4rem] md:pt-[5rem] pb-[10rem] md:pb-[12rem]">
                <div className="max-w-[1440px] mx-auto px-6 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-20">
                        {[
                            { icon: 'school', titleKey: 'servico_1_title', descKey: 'servico_1_desc' },
                            { icon: 'groups', titleKey: 'servico_2_title', descKey: 'servico_2_desc' },
                            { icon: 'verified', titleKey: 'servico_3_title', descKey: 'servico_3_desc' },
                            { icon: 'play_lesson', titleKey: 'servico_4_title', descKey: 'servico_4_desc' },
                            { icon: 'biotech', titleKey: 'servico_5_title', descKey: 'servico_5_desc' },
