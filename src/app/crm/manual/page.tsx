  ...
  return (
    <div className={`rounded-lg border px-4 py-3 my-3 text-sm ${styles[tone]}`}>
      <div className="font-medium mb-1">
        {icons[tone]} {title ?? defaultTitle[tone]}
      </div>
      <div>{children}</div>
    </div>
  )
...
function Badge({ color, children }: { color: string; children: React.ReactNode }) {
  ...
  return (
    <span
      className={`rounded px-2 py-0.5 text-[10px] uppercase tracking-wide font-medium mr-2 ${map[color] ?? map.neutral}`}
    >
      {children}
    </span>
  )
  ...
  return (
    <div className="max-w-4xl space-y-2">
      ...
      <ul className="list-disc list-inside text-sm space-y-1 ml-2">
        ...
        <li>
          Enviar propostas por <strong>link público</strong> — o cliente aceita com 1 clique.
        </li>
      ...
      <ul className="space-y-3 text-sm">
        ...
        <li>
          ...
          Acesso amplo ao CRM sem as funções administrativas restritas ao admin. Exemplo:{' '}
          <strong>Mateus Sacavem</strong>.
        </li>
        <li>
          <Badge color="neutral">unit: studio</Badge>
          Gestor de uma unidade. Vê apenas leads/clientes/propostas/faturas da sua unidade (filtrado
          por <Path>business_unit</Path>).
        </li>
      </ul>
      <Box tone="info">
      ...
      <div className="text-sm space-y-3">
        <div className="rounded-lg border border-neutral-100 bg-white p-4">
          <p className="font-semibold text-neutral-700 mb-2 text-xs uppercase tracking-widest">
            Principal
          </p>
          <ul className="space-y-1">
            <li>
              <strong>◈ Dashboard</strong> — KPIs, gráficos, atividade recente.
            </li>
            <li>
              <strong>⟡ Leads</strong> — lista completa com badge âmbar (leads em aberto).
            </li>
            <li>
              <strong>◎ Clientes</strong> — base de clientes com badge vermelho (faturas vencidas).
            </li>
            <li>
              <strong>◇ Oportunidades</strong> — Kanban de negociações.
            </li>
          </ul>
        </div>
        <div className="rounded-lg border border-neutral-100 bg-white p-4">
          ...
          <ul className="space-y-1">
            <li>
              <strong>▤ Propostas</strong> — todas as propostas criadas.
            </li>
            <li>
              <strong>▦ Faturas</strong> — emitidas, pagas, vencidas.
            </li>
          </ul>
        </div>
        <div className="rounded-lg border border-neutral-100 bg-white p-4">
          ...
          <ul className="space-y-1">
            <li>
              <strong>◉ Campanhas</strong> — atribuição UTM e ROAS.
            </li>
            <li>
              <strong>✉ Newsletter</strong> — inscritos, histórico de disparos, envio por artigo.
            </li>
            <li>
              <strong>⟳ Automações</strong> — regras e histórico de execuções.
            </li>
            <li>
              <strong>▨ Relatórios</strong> — métricas detalhadas.
            </li>
          </ul>
        </div>
        <div className="rounded-lg border border-neutral-100 bg-white p-4">
          ...
          <ul className="space-y-1">
            <li>
              <strong>▣ Catálogo</strong> — serviços e pacotes pré-cadastrados.
            </li>
            <li>
              <strong>◈ Tags</strong> — rótulos personalizados.
            </li>
            <li>
              <strong>▥ Manual</strong> — este documento.
            </li>
            <li>
              <strong>◌ Ajuda</strong> — guia rápido de links.
            </li>
          </ul>
        </div>
        <div className="rounded-lg border border-neutral-100 bg-white p-4">
          <p className="font-semibold text-neutral-700 mb-2 text-xs uppercase tracking-widest">
            Admin <Badge color="violet">admin only</Badge>
          </p>
          <ul className="space-y-1">
            <li>
              <strong>◑ Academy</strong> — pedidos, certificados, produtos.
            </li>
            <li>
              <strong>◐ Usuários</strong> — gerenciar perfis e permissões.
            </li>
            <li>
              <strong>◒ Auditoria</strong> — log de ações críticas do sistema.
            </li>
          </ul>
        </div>
      </div>
      ...
      <p className="text-sm">
        Toda vez que alguém preenche um formulário em <Path>housemazzutti.com</Path> (formulários
        das páginas Studio, Agência, Produtora, Comunidade ou qualquer formulário de contato), um
        lead é criado automaticamente via Edge Function <Path>submit_lead</Path>. Acesse em{' '}
        <Link href="/crm/leads" className="text-blue-600 underline">
          /crm/leads
        </Link>
        .
      </p>
      ...
      <ol className="space-y-3 mt-2">
        ...
        <Step n={4}>
          ...
          (respostas do formulário em JSON), <strong>Anexos</strong>, <strong>Propostas</strong>e{' '}
          <strong>Oportunidades</strong> vinculadas.
        </Step>
        <Step n={5}>
      ...
      <Box tone="do" title="Bom registro">
        <span className="font-mono text-xs">
          📞 call · "Liguei, Maria vai pedir orçamento na próxima semana"
        </span>
      </Box>
      ...
      <p className="text-sm">
        ...
        <Link href="/crm/leads/new" className="text-blue-600 underline">
          /crm/leads/new
        </Link>{' '}
      ...
      <ol className="space-y-2 mt-2">
        <Step n={1}>
          <strong>Título</strong> — já vem como "Proposta — Nome do Cliente". Edite se precisar.
        </Step>
        <Step n={2}>
          <strong>Válida até</strong> — data limite de aceite. Padrão: 30 dias.
        </Step>
        <Step n={3}>
          <strong>Desconto (R$)</strong> — em reais. Zero se não houver.
        </Step>
        <Step n={4}>
          <strong>Pacotes do catálogo</strong> — marque os itens desejados pelo cliente.
        </Step>
        <Step n={5}>
          <strong>Add-ons globais</strong> — extras aplicáveis a qualquer unidade.
        </Step>
        <Step n={6}>
          <strong>Observações internas</strong> — só equipe vê. Escopo, condições especiais.
        </Step>
        <Step n={7}>
          Clique <strong>Criar proposta</strong>. Voltará ao lead com a proposta listada e atividade{' '}
          <em>quote_sent</em> na timeline.
        </Step>
      </ol>
      <Box tone="warn">
        Selecione ao menos um pacote ou add-on — o sistema rejeita propostas vazias.
      </Box>

      <H3 id="enviar-proposta" n="5.2" title="Enviar a proposta" />
      <ul className="text-sm space-y-2">
        <li>
          🔗 <strong>Copiar link público</strong> — URL{' '}
          <Path>https://housemazzutti.com/p/&lt;token&gt;</Path>. Cole no WhatsApp.
        </li>
        <li>
          🖨️ <strong>Imprimir / Salvar PDF</strong> — abre versão A4 limpa. Cmd+P → "Salvar como
          PDF".
        </li>
        <li>
          <strong>Marcar como enviada</strong> — registra horário do envio.
        </li>
        <li>
          ✓ <strong>Marcar como aceita</strong> — força aceite manual (quando cliente confirmou por
          telefone).
        </li>
        <li>
          ✗ <strong>Recusada</strong> — fecha sem virar fatura.
        </li>
      </ul>
      ...
      <p className="text-sm">
        ...
        subtotal, desconto, <strong>total em destaque</strong> e botão{' '}
        <strong>✓ Aceitar e iniciar</strong>.
      </p>
      <Box tone="tip">
        Quando o cliente clica em Aceitar: proposta marcada como <em>aceito</em>, oportunidade
        marcada como <em>ganho</em>, atividade registrada na timeline e badge de atividade
        atualizado.
      </Box>
      ...
      <ol className="space-y-2 mt-2">
        <Step n={1}>
          Com proposta no status <em>aceito</em>, abra-a em <Path>/crm/quotes/[id]</Path>.
        </Step>
        <Step n={2}>
          Preencha o campo <strong>Vencimento</strong> e clique <strong>Gerar fatura</strong>.
        </Step>
        <Step n={3}>
        ...
        <Step n={4}>
          Você é redirecionado para <Path>/crm/clients/[id]</Path> — fatura com status{' '}
          <em>emitida</em>.
        </Step>
      </ol>
      ...
      <ol className="space-y-2 mt-2">
        <Step n={1}>
          Vá em <Path>/crm/clients/[id]</Path>.
        </Step>
        <Step n={2}>
          Na seção <strong>Pagamentos recentes</strong>: escolha a fatura, método
          (PIX/boleto/cartão/TED), valor, referência e data.
        </Step>
        <Step n={3}>
      ...
      <Box tone="warn">
        Registre o valor exato recebido. Ajuste a fatura antes se houver desconto adicional.
      </Box>
      ...
      <p className="text-sm">
        ...
        <Link href="/crm/clients" className="text-blue-600 underline">
          /crm/clients
        </Link>{' '}
        você vê a lista com LTV e última compra.
      </p>
      <p className="text-sm mt-2">
        ...
        <strong>Em aberto</strong>. Abaixo: histórico de faturas, pagamentos, propostas,
        oportunidades e anexos.
      </p>
      ...
      <p className="text-sm">
        Em{' '}
        <Link href="/crm/opportunities" className="text-blue-600 underline">
          /crm/opportunities
        </Link>
      ...
      <p className="text-sm">
        ...
        artigos em{' '}
        <Link href="/crm/newsletter" className="text-blue-600 underline">
          /crm/newsletter
        </Link>
        .
      </p>
      ...
      <ol className="space-y-2 mt-2">
        ...
        <Step n={4}>
          Clique <strong>Enviar para X inscritos</strong>. O sistema dispara via Resend em lotes de
          50, salva o registro em <Path>newsletter_sends</Path> e mostra quantos e-mails foram
          entregues.
        </Step>
      </ol>
      <Box tone="info">
      ...
      <p className="text-sm">
        A tabela de inscritos mostra e-mail, nome, origem, data de inscrição e status (Ativo /
        Inativo). Clique no status de um inscrito para alternar manualmente. Use o campo de busca e
        os filtros Todos / Ativos / Inativos para navegar.
      </p>
      <Box tone="tip">
      ...
      <p className="text-sm">
        ...
        <Link href="/crm/academy" className="text-blue-600 underline">
          /crm/academy
        </Link>
        .
      </p>
      ...
      <p className="text-sm">
        Lista todos os pedidos de cursos com: número do pedido, comprador, produto, valor, status de
        pagamento (Mercado Pago) e data. Filtrável por status e com busca por e-mail.
      </p>
      ...
      <p className="text-sm">
        Em{' '}
        <Link href="/crm/campaigns" className="text-blue-600 underline">
          /crm/campaigns
        </Link>
        : leads atribuídos por UTM, gasto declarado, receita atribuída e ROAS (receita ÷ gasto). Use
        para decidir onde alocar mais investimento de mídia.
      </p>
      <Box tone="tip">
      ...
      <p className="text-sm">
        ...
        <Link href="/crm/automations" className="text-blue-600 underline">
          /crm/automations
        </Link>
      ...
      <ul className="text-sm space-y-1 ml-2">
        <li>
          • <strong>Boas-vindas</strong> — lead criado → atividade "Lead recebido (auto)".
        </li>
        <li>
          • <strong>Onboarding</strong> — proposta aceita → opp marcada como ganho + atividade.
        </li>
        <li>
          • <strong>Cobrança</strong> — fatura vence → marcada como vencida (cron diário).
        </li>
        <li>
          • <strong>Reengajamento</strong> — lead sem atividade há 14 dias → task de follow-up.
        </li>
      </ul>
      ...
      <ol className="space-y-2 mt-2">
        ...
        <Step n={2}>
          Dê um <strong>nome</strong> descritivo.
        </Step>
        <Step n={3}>
          <strong>Gatilho</strong> — 7 opções: lead criado, status mudou, proposta aceita, fatura
          vencida, lead inativo, cron customizado.
        </Step>
        <Step n={4}>
          <strong>Condições (JSON)</strong> — filtro. Ex:{' '}
          <Path>{`{"status_in":["qualificado"]}`}</Path>.
        </Step>
        <Step n={5}>
          <strong>Ações (JSON)</strong> — use os templates de botão: create_activity, send_email,
          update_opportunity_ganho, follow_up.
        </Step>
        <Step n={6}>
          Marque <strong>Ativa</strong> e salve.
        </Step>
      </ol>
      <Box tone="warn">
        Automações são território de admin. JSON errado pode parar regras críticas. Em dúvida,
        consulte Angelo.
      </Box>
      ...
      <ol className="space-y-2 mt-2">
        <Step n={1}>
          Clique <strong>Escolher arquivo</strong> (PDF, imagem, doc — até 10 MB).
        </Step>
        ...
        <Step n={4}>
          Arquivo no bucket privado <Path>crm-assets</Path>. Para baixar: clique no nome → link
          assinado por 5 minutos.
        </Step>
      </ol>
      ...
      <p className="text-sm">
        Em{' '}
        <Link href="/crm/tags" className="text-blue-600 underline">
          /crm/tags
        </Link>
        : crie rótulos para categorizar leads e clientes além do status oficial. Exemplos:
      </p>
      <ul className="list-disc list-inside text-sm ml-2">
        <li>
          <strong>VIP</strong> — cliente prioritário
        </li>
        <li>
          <strong>frio</strong> — não responde há muito tempo
        </li>
        <li>
          <strong>indicação</strong> — veio por recomendação
        </li>
        <li>
          <strong>parceiro-comercial</strong> — agência que envia volume
        </li>
      </ul>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm mt-2">
        {[
          ...
          <div key={k} className="border border-neutral-200 rounded p-2 font-medium">
            {k}
          </div>
        ))}
      </div>
      ...
      <ul className="text-sm space-y-1.5 mt-2">
        <li>
          <strong>Leads por status (barras)</strong> — onde estão acumulando no funil.
        </li>
        <li>
          <strong>Funil de oportunidades</strong> — quantidade + valor por estágio.
        </li>
        <li>
      ...
      <p className="text-sm">
        Cada lista tem botão <strong>↓ CSV</strong>. Atalhos diretos:
      </p>
      ...
      <Box tone="tip">
        Limite de 10.000 linhas por exportação. Para contabilidade, exporte Pagamentos no fim do
        mês.
      </Box>
      ...
      <p className="text-sm">
        Campo de busca em{' '}
        <Link href="/crm/search" className="text-blue-600 underline">
          /crm/search
        </Link>
      ...
      <Box tone="do" title="Faça">
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>
            Ao final do dia, zere a fila de leads com status <em>novo</em>.
          </li>
      ...
      <Box tone="dont" title="Não faça">
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>
            Não delete leads — use status <em>arquivado</em> ou <em>perdido</em>.
          </li>
      ...
      <dl className="text-sm space-y-3">
        {[
          ...
          [
            'Cliente',
            'Lead que já comprou (fatura emitida ou promoção manual). Tem LTV, faturas, pagamentos.',
          ],
          [
            'Oportunidade',
          ...
          [
            'LTV (Lifetime Value)',
            'Soma total pago pelo cliente ao longo do tempo. Métrica-chave da relação.',
          ],
          [
            'ROAS',
          ...
          [
            'Pipeline ponderado',
            'Soma de (valor × probabilidade %) de oportunidades abertas. Forecast realista.',
          ],
          [
            'Inscrito (newsletter)',
            'Visitante que se cadastrou na Carta House Mazzutti pelo blog.',
          ],
      ...
      <footer className="border-t border-neutral-200 pt-6 mt-10 text-xs text-neutral-400">
        Manual versão 2.0 · Atualizado em maio/2026 · House Mazzutti. Dúvidas técnicas:{' '}
        <a href="mailto:angelo@housemazzutti.com" className="underline">
          angelo@housemazzutti.com
        </a>
      </footer>
    </div>
  )
