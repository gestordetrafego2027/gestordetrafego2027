...
export default function Sidebar({
  ...
  return (
    ...
    >
      {/* Logo / Header */}
      <div
        className={`flex items-center justify-between px-4 py-4 border-b border-neutral-100 ${collapsed ? 'px-3' : ''}`}
      >
        {!collapsed && (
          <Link href="/crm" className="flex items-center gap-2 group">
            ...
            {!!newActivities && (
              <span
                className="inline-flex items-center justify-center rounded-full bg-emerald-500 text-white text-[9px] w-4 h-4 leading-none tabular-nums"
                ...
                return (
                  <li key={item.href}>
                    ...
                    >
                      ...
                      {!collapsed && !!badge && (
                        <span
                          className={`inline-flex items-center justify-center rounded-full text-white text-[9px] px-1.5 py-0.5 leading-none tabular-nums ${
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1 mt-0.5">
                  {userRole === 'admin' && (
                    <span className="rounded bg-violet-100 text-violet-700 text-[9px] px-1.5 py-0.5 uppercase tracking-wide">
                      admin
                    </span>
                  )}
                  {userUnit && userRole !== 'admin' && (
                    <span className="rounded bg-blue-100 text-blue-700 text-[9px] px-1.5 py-0.5 uppercase tracking-wide">
                      {userUnit}
                    </span>
                  )}
                </div>
