                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => setSelectedImg('/images/studio/paula-assuncao/1.jpg')} className="cursor-pointer">
                            <img alt="Foto 1" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/paula-assuncao/1.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/paula-assuncao/2.jpg')} className="cursor-pointer">
                            <img alt="Foto 2" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/paula-assuncao/2.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/paula-assuncao/3.jpg')} className="cursor-pointer">
