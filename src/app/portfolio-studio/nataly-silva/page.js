                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div onClick={() => setSelectedImg('/images/studio/nataly-silva/3.jpg')} className="cursor-pointer">
                            <img alt="Foto 3" className="w-full aspect-[3/4] object-cover" src="/images/studio/nataly-silva/3.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/nataly-silva/4.jpg')} className="cursor-pointer">
                            <img alt="Foto 4" className="w-full aspect-[3/4] object-cover" src="/images/studio/nataly-silva/4.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/nataly-silva/5.jpg')} className="cursor-pointer">
                            <img alt="Foto 5" className="w-full aspect-[3/4] object-cover" src="/images/studio/nataly-silva/5.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/nataly-silva/6.jpg')} className="cursor-pointer">
                            <img alt="Foto 6" className="w-full aspect-[3/4] object-cover" src="/images/studio/nataly-silva/6.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/nataly-silva/7.jpg')} className="cursor-pointer">
                            <img alt="Foto 7" className="w-full aspect-[3/4] object-cover" src="/images/studio/nataly-silva/7.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/nataly-silva/8.jpg')} className="cursor-pointer">
                            <img alt="Foto 8" className="w-full aspect-[3/4] object-cover" src="/images/studio/nataly-silva/8.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/nataly-silva/9.jpg')} className="cursor-pointer">
                            <img alt="Foto 9" className="w-full aspect-[3/4] object-cover" src="/images/studio/nataly-silva/9.jpg"/>
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
