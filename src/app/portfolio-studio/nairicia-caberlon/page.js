                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => setSelectedImg('/images/studio/nairicia-caberlon/1.jpg')} className="cursor-pointer">
                          ...
                          <div onClick={() => setSelectedImg('/images/studio/nairicia-caberlon/2.jpg')} className="cursor-pointer">
                          ...
                          <div onClick={() => setSelectedImg('/images/studio/nairicia-caberlon/3.jpg')} className="cursor-pointer">
                            <img alt="Foto 3" className="w-full aspect-[3/4] object-cover" src="/images/studio/nairicia-caberlon/3.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/nairicia-caberlon/4.jpg')} className="cursor-pointer">
                            <img alt="Foto 4" className="w-full aspect-[3/4] object-cover" src="/images/studio/nairicia-caberlon/4.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/nairicia-caberlon/5.jpg')} className="cursor-pointer">
                            <img alt="Foto 5" className="w-full aspect-[3/4] object-cover" src="/images/studio/nairicia-caberlon/5.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/nairicia-caberlon/6.jpg')} className="cursor-pointer">
