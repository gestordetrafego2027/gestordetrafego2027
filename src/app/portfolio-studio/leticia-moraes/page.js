...
export default function LeticiaMoraesPage() {
    ...
    return (
        <div className="bg-surface text-on-surface antialiased">
                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => openImg('/images/studio/leticia-moraes/1.jpg')} className="cursor-pointer">
                            <Image alt="Foto 1" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/1.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leticia-moraes/2.jpg')} className="cursor-pointer">
                            <Image alt="Foto 2" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/2.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leticia-moraes/3.jpg')} className="cursor-pointer">
                            <Image alt="Foto 3" src="/images/studio/leticia-moraes/3.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leticia-moraes/4.jpg')} className="cursor-pointer">
                            <Image alt="Foto 4" src="/images/studio/leticia-moraes/4.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leticia-moraes/5.jpg')} className="cursor-pointer">
                            <Image alt="Foto 5" src="/images/studio/leticia-moraes/5.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leticia-moraes/6.jpg')} className="cursor-pointer">
                            <Image alt="Foto 6" src="/images/studio/leticia-moraes/6.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leticia-moraes/7.jpg')} className="cursor-pointer">
                            <Image alt="Foto 7" src="/images/studio/leticia-moraes/7.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leticia-moraes/8.jpg')} className="cursor-pointer">
                            <Image alt="Foto 8" src="/images/studio/leticia-moraes/8.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                          <div onClick={() => openImg('/images/studio/leticia-moraes/9.jpg')} className="cursor-pointer">
                            <Image alt="Foto 9" src="/images/studio/leticia-moraes/9.jpg" width={800} height={1200} sizes="(max-width: 768px) 100vw, 50vw" quality={85} loading="lazy" className="w-full aspect-[3/4] object-cover" />
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface hmzt-hero-title">Leticia Moraes</h1>
                            </div>
            ...
            <PortfolioCTA businessUnit="studio" projectSlug="leticia-moraes" />
