                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => setSelectedImg('/images/studio/leticia-moraes/1.jpg')} className="cursor-pointer">
                            <img alt="Foto 1" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/1.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/leticia-moraes/2.jpg')} className="cursor-pointer">
                            <img alt="Foto 2" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/2.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/leticia-moraes/3.jpg')} className="cursor-pointer">
                            <img alt="Foto 3" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/3.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/leticia-moraes/4.jpg')} className="cursor-pointer">
                            <img alt="Foto 4" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/4.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/leticia-moraes/5.jpg')} className="cursor-pointer col-span-2">
                            <img alt="Foto 5" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/5.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/leticia-moraes/6.jpg')} className="cursor-pointer col-span-2">
                            <img alt="Foto 6" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/6.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/leticia-moraes/7.jpg')} className="cursor-pointer col-span-2">
                            <img alt="Foto 7" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/7.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/leticia-moraes/8.jpg')} className="cursor-pointer col-span-2">
                            <img alt="Foto 8" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/8.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/leticia-moraes/9.jpg')} className="cursor-pointer col-span-2">
                            <img alt="Foto 9" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/9.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/leticia-moraes/10.jpg')} className="cursor-pointer col-span-2">
                            <img alt="Foto 10" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/10.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/leticia-moraes/capa.jpg')} className="cursor-pointer col-span-2">
                            <img alt="Foto capa" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/leticia-moraes/capa.jpg"/>
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface">Leticia Moraes</h1>
                            </div>
                            ...
                            <div className="space-y-[16px] pt-4">
                                <div className="info-col-anim flex flex-col">
                                    ...
                                    <p className="font-inter text-sm font-medium">Book</p>
                                </div>
                                <div className="info-col-anim flex flex-col">
