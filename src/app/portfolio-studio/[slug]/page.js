                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-2">
                          <div className="aspect-square overflow-hidden">
                            <img className="w-full h-full object-cover" src={`/images/studio/${slug}/1.jpg`} alt={`Foto 1`} />
                          </div>
                          <div className="aspect-square overflow-hidden">
                            <img className="w-full h-full object-cover" src={`/images/studio/${slug}/2.jpg`} alt={`Foto 2`} />
                          </div>
                          <div className="aspect-square overflow-hidden">
                            <img className="w-full h-full object-cover" src={`/images/studio/${slug}/3.jpg`} alt={`Foto 3`} />
                          </div>
                          <div className="aspect-square overflow-hidden">
                            <img className="w-full h-full object-cover" src={`/images/studio/${slug}/4.jpg`} alt={`Foto 4`} />
                          </div>
                          <div className="aspect-square overflow-hidden">
                            <img className="w-full h-full object-cover" src={`/images/studio/${slug}/5.jpg`} alt={`Foto 5`} />
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
