                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div onClick={() => openImg('/images/studio/jamile-caroline/3.jpg')} className="cursor-pointer">
                            <img alt="Foto 3" className="w-full aspect-[3/4] object-cover" src="/images/studio/jamile-caroline/3.jpg"/>
                          </div>
                          <div onClick={() => openImg('/images/studio/jamile-caroline/4.jpg')} className="cursor-pointer">
                            <img alt="Foto 4" className="w-full aspect-[3/4] object-cover" src="/images/studio/jamile-caroline/4.jpg"/>
                          </div>
                          <div onClick={() => openImg('/images/studio/jamile-caroline/5.jpg')} className="cursor-pointer">
                            <img alt="Foto 5" className="w-full aspect-[3/4] object-cover" src="/images/studio/jamile-caroline/5.jpg"/>
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
