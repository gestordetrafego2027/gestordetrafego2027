...
export default function VitriaBoidtPage() {
                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-2/3">
                        <div className="portfolio-grid">
                          <div onClick={() => setSelectedImg('/images/studio/vitoria-boidt/1.jpg')} className="cursor-pointer">
                            <img alt="Foto 1" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/vitoria-boidt/1.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/vitoria-boidt/2.jpg')} className="cursor-pointer">
                            <img alt="Foto 2" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/vitoria-boidt/2.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/vitoria-boidt/3.jpg')} className="cursor-pointer">
                            <img alt="Foto 3" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/vitoria-boidt/3.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/vitoria-boidt/4.jpg')} className="cursor-pointer">
                            <img alt="Foto 4" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/vitoria-boidt/4.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/vitoria-boidt/5.jpg')} className="cursor-pointer col-span-2">
                            <img alt="Foto 5" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/vitoria-boidt/5.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/vitoria-boidt/6.jpg')} className="cursor-pointer col-span-2">
                            <img alt="Foto 6" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/vitoria-boidt/6.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/vitoria-boidt/capa.jpg')} className="cursor-pointer col-span-2">
                            <img alt="Foto capa" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/vitoria-boidt/capa.jpg"/>
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
                    <div className="lg:w-1/3">
                        <div className="info-col flex flex-col gap-[16px]">
                            <div className="space-y-1">
                                ...
                                <h1 className="info-col-anim font-newsreader text-6xl font-light -tracking-[0.02em] leading-tight text-on-surface">Vitória Boidt</h1>
                            </div>
