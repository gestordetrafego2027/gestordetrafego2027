                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 gap-3">
                          <div onClick={() => setSelectedImg('/images/studio/ana-laura-saar/1.jpg')} className="cursor-pointer">
                            <img alt="Foto 1" className="w-full aspect-[3/4] object-cover" style={{objectPosition: 'top'}} src="/images/studio/ana-laura-saar/1.jpg"/>
                          </div>
                          <div onClick={() => setSelectedImg('/images/studio/ana-laura-saar/2.jpg')} className="cursor-pointer">
                          ...
                          <div onClick={() => setSelectedImg('/images/studio/ana-laura-saar/5.jpg')} className="cursor-pointer">
                            <img alt="Foto 5" className="w-full aspect-[3/4] object-cover" src="/images/studio/ana-laura-saar/5.jpg"/>
                          </div>
                        </div>
                    </div>
                    {/* Content Sidebar */}
