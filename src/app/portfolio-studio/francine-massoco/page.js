...
export default function FrancineMassocoPage() {
  ...
  <img src="/images/studio/francine-massoco/1.jpg" alt="Foto 1" style={{width: '100%', aspectRatio: '3/4', objectFit: 'cover'}} />
  <img src="/images/studio/francine-massoco/2.jpg" alt="Foto 2" style={{width: '100%', aspectRatio: '3/4', objectFit: 'cover'}} />
  <img src="/images/studio/francine-massoco/3.jpg" alt="Foto 3" style={{width: '100%', aspectRatio: '3/4', objectFit: 'cover'}} />
  <img src="/images/studio/francine-massoco/4.jpg" alt="Foto 4" style={{width: '100%', aspectRatio: '3/4', objectFit: 'cover'}} />
</div>
                    </div>
                    {/* Content Sidebar */}
